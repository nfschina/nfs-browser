...
class WebPluginDelegateImpl : public WebPluginDelegate {
 public:
  ...
  gfx::AcceleratedWidget windowed_handle() const { return windowed_handle_; }
 ...
 private:
...
#if defined(OS_LINUX)
  void MovePluginWindow(const gfx::Rect& clip_rect);
#endif
  ...
  // work offscreen.
  gfx::AcceleratedWidget windowed_handle_;
