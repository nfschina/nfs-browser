...
class CONTENT_EXPORT RenderFrameImpl
 ...
 public:
  blink::WebURLError CreateError() override;//add by wangn
  void loadErrorPage(int reason) override;//add by wangn
  ...
  void runModalAddFavorite(const blink::WebString& url, const blink::WebString& title) override;
 ...
 private:
  ...
  void OnJsReceived(int flag);//add by wangn
  ...
  void OnSetCompatibleMode(bool mode);
  ...
  void OnRestoreVideoPopupWindow(const std::string& extension_id);
  ...
  // NFS Collect error page details
  void ConnectErrorPageInfo(const blink::WebURLError& error_info);
