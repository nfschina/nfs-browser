...
class WebPluginImpl : public WebPlugin,
 ...
 public:
  ...
  void SetWindow(gfx::AcceleratedWidget window) override;
  void SetAcceptsInputEvents(bool accepts) override;
  void WillDestroyWindow(gfx::AcceleratedWidget window) override;
 ...
 private:
  ...
  class LoaderClient : public blink::WebURLLoaderClient {
   public:
    ...
    bool willFollowRedirect(blink::WebURLLoader*,
                            blink::WebURLRequest&,
