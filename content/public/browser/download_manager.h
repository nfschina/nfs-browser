...
class CONTENT_EXPORT DownloadManager : public base::SupportsUserData::Data {
 public:
  ...
  class CONTENT_EXPORT Observer {
   public:
    virtual void OnDownloadPromptd(
        content::DownloadManager* manager, content::DownloadCreateInfo* info) {}
    ...
    virtual void OnDownloadReCreated(
        DownloadManager* manager, DownloadItem* item) {}
  ...
  virtual base::FilePath GetDefaultDownloadPath() = 0;
};
