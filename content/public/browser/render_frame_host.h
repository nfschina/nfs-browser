...
class CONTENT_EXPORT RenderFrameHost : public IPC::Listener,
 ...
 public:
  ...
  virtual void setVideoPopupWindowStatus(bool is_video_popup_window) = 0;
  virtual bool getVideoPopupWindowStatus() = 0;
  virtual void setVideoPopupWindowInfo(const std::string& video_popup_window_info) = 0;
  virtual const std::string& getVideoPopupWindowInfo() = 0;
  virtual void RestoreVideoPopupWindow(const std::string& extension_id) = 0;

  virtual void SetCompatibleMode(bool mode) = 0;
