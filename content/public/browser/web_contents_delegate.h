...
class CONTENT_EXPORT WebContentsDelegate {
 public:
  ...
  virtual void AddFavorite(const base::string16& url, const base::string16& title) {}
  ...
  // huk added
  virtual void RecordErrorPageInfo(const std::string& url, const std::string& detail) {}

  virtual void OpenSearchContent(const base::string16& search_text) {}
