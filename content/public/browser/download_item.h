...
class CONTENT_EXPORT DownloadItem : public base::SupportsUserData {
 public:
  ...
  virtual std::string GetPackUrl() const = 0;
  ...
  virtual void DeleteFileOnDisk(bool delete_file) = 0;

  virtual std::string GetBtRealFileName() = 0;
  virtual void SetBtRealFileName(std::string file_name) = 0;
