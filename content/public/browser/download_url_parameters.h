...
class CONTENT_EXPORT DownloadUrlParameters {
 public:
  ...
  // Define the download url source from, for different response
  enum UrlSourceFrom {
    URL_SOURCE_FROM_UNKNOW,
    URL_SOURCE_FROM_SAVEAS,
    URL_SOURCE_FROM_SAVELINKSAS,
    URL_SOURCE_FROM_SAVEIMAGEAS
  };
  ...
  // Set the url source form
  void set_url_source_from(UrlSourceFrom url_source_from) {
    url_source_from_ = url_source_from;
  }
  ...
  UrlSourceFrom url_source_from() const { return url_source_from_; }
 ...
 private:
  ...
  UrlSourceFrom url_source_from_;
