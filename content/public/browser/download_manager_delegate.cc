...
int DownloadManagerDelegate::GetDownloadMaxSpeed() {
  return 0;
}

base::FilePath DownloadManagerDelegate::GetUserDataPath() {
  return base::FilePath();
}

bool DownloadManagerDelegate::ShouldNoteDownloadQuit() const {
  return false;
}

bool DownloadManagerDelegate::ShouldContinueLastDownload() const {
  return false;
}

bool DownloadManagerDelegate::ShouldPromptForDownload() const {
  return false;
}

std::string DownloadManagerDelegate::GetReferrerCharset() const {
  return std::string();
}

std::string DownloadManagerDelegate::GetDownloadDefaultFileName() const {
  return std::string();
}

bool DownloadManagerDelegate::ShouldDownloadUpdate() {
  return true;
}

bool DownloadManagerDelegate::IsOffTheRecord() const {
  return false;
}
