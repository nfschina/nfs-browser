...
IPC_STRUCT_TRAITS_BEGIN(content::WebPreferences)
  ...
  IPC_STRUCT_TRAITS_MEMBER(click_prerender_enabled)
  IPC_STRUCT_TRAITS_MEMBER(mouse_over_prerender_enabled)
  ...
  IPC_STRUCT_TRAITS_MEMBER(operating_system_name)
#if defined(OS_WIN) ||defined(OS_LINUX)
  IPC_STRUCT_TRAITS_MEMBER(mac_address)
#endif
  IPC_STRUCT_TRAITS_MEMBER(compatible_mode)
IPC_STRUCT_TRAITS_END()
