...
class CONTENT_EXPORT NavigationControllerImpl
 ...
 public:
  ...
  void LoadURLWithParams(const LoadURLParams& params, bool for_prerender = false) override;
 ...
 private:
  ...
  void LoadEntry(std::unique_ptr<NavigationEntryImpl> entry, bool for_prerender = false);
  ...
  bool NavigateToPendingEntryInternal(ReloadType reload_type, bool for_prerender = false);
  ...
  void NavigateToPendingEntry(ReloadType reload_type, bool for_prerender = false);
