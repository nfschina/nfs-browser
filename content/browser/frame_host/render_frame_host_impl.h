...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 public:
  ...
  void setVideoPopupWindowStatus(bool is_video_popup_window) override;
  bool getVideoPopupWindowStatus() override;
  void setVideoPopupWindowInfo(const std::string& video_popup_window_info) override;
  const std::string& getVideoPopupWindowInfo() override;
  void RestoreVideoPopupWindow(const std::string& extension_id) override;
  void FilesSelectedInChooser(const std::vector<FileChooserFileInfo>& files,
                              FileChooserParams::Mode permissions) override;
  void RequestTextSurroundingSelection(
      const TextSurroundingSelectionCallback& callback,
      int max_length) override;
  void SetCompatibleMode(bool mode) override;
  ...
  void OnContextMenuPublic(const ContextMenuParams& params) {//yana add 161215
 ...
 private:
  ...
  void OnJavaScriptAddFavoriteMessage(const base::string16& url, const base::string16& title);
  ...
  bool isVideoPopupWindow;
  std::string videoPopupWindowInfo;
