...
bool DownloadItemImplDelegate::ProhibitConcat(std::string url) {
  return false;
}
...
void DownloadItemImplDelegate::ResumeInterruptedDownloadEx(
    DownloadItemImpl* download,
...
bool DownloadItemImplDelegate::ShouldUseSaveAsDownloadMode(GURL url, bool find_delete) {
  return false;
}
