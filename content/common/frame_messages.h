...
IPC_STRUCT_TRAITS_BEGIN(blink::WebFindOptions)
  ...
  IPC_STRUCT_TRAITS_MEMBER(fromSelection)
...
IPC_MESSAGE_ROUTED1(FrameMsg_FromJsSendMsg,int)//add by wangn
...
IPC_MESSAGE_ROUTED1(FrameMsg_RestoreVideoPopupWindow,
...
// Indicates that the current frame has add favorite message.
IPC_MESSAGE_ROUTED2(FrameHostMsg_JavaScriptAddFavoriteMessage,
                    base::string16,
                    base::string16)
...
// huk added
IPC_MESSAGE_ROUTED2(FrameHostMsg_CollectErrorPageInfo,
                    std::string /* url */,
                    int /* error code */)
