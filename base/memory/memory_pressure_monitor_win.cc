...
const int MemoryPressureMonitor::kLargeMemoryThresholdMb = 2048;
...
const int MemoryPressureMonitor::kSmallMemoryDefaultCriticalThresholdMb = 100;
...
const int MemoryPressureMonitor::kLargeMemoryDefaultCriticalThresholdMb = 200;
