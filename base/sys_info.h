...
class BASE_EXPORT SysInfo {
 public:
  ...
  static std::string GetMacAddressMd5();
  static std::string GetMacAddresNfs();
  static void SetMacAddresNfs(std::string mac_address);
#endif
  ...
  static void SetOperatingSystemName(std::string name) {
    strncpy(operating_system_name, name.c_str(), name.size());
  }
  static char* GetOperatingSystemName() {
    return operating_system_name;
  }

  static char operating_system_name[128];
