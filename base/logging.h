...
//huk
#define COMPACT_GOOGLE_LOG_EX_CDOS(ClassName, ...) \
  ::logging::ClassName(__FILE__, __LINE__, ::logging::LOG_CDOS, ##__VA_ARGS__)
...
#define COMPACT_GOOGLE_LOG_CDOS \
  COMPACT_GOOGLE_LOG_EX_CDOS(LogMessage)
