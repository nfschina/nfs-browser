...
static int reap_filters(int flush)
{
    ...
    for (i = 0; i < nb_output_streams; i++) {
        ...
        while (1) {
            ...
            printf("av_buffersink_get_frame_flags-------------------\n");
...
static int init_output_stream(OutputStream *ost, char *error, int error_len)
{
    ...
    if (ost->encoding_needed) {
        ...
        if (ost->enc->type == AVMEDIA_TYPE_AUDIO &&
            ...
            printf("av_buffersink_set_frame_size------------\n");
...
static int transcode_init(void)
{
    ...
    for (i = 0; i < nb_output_streams; i++) {
        ...
        if (ost->stream_copy) {
            ...
            printf("init_simple_filtergraph------------------\n");
            /*if (!ost->filter &&
            ...
            if (enc_ctx->codec_type == AVMEDIA_TYPE_VIDEO) {
                if (!ost->frame_rate.num) {
                    printf("av_buffersink_get_frame_rate----------\n");
 ...
 dump_format:
    ...
    for (i = 0; i < nb_input_streams; i++) {
        ...
        for (j = 0; j < ist->nb_filters; j++) {
            printf("filtergraph_is_simple-------2\n");
/*            if (!filtergraph_is_simple(ist->filters[j]->graph)) {
    ...
    for (i = 0; i < nb_output_streams; i++) {
        ...
        if (ost->attachment_filename) {
         ...
         printf("filter->graph->graph_desc---------------\n");
    ...
    if (key == 'c' || key == 'C'){
        ...
        if (k > 0 &&
            ...
            for (i = 0; i < nb_filtergraphs; i++) {
                ...
                if (fg->graph) {
                    if (time < 0) {
                        printf("avfilter_graph_send_command----------\n");
                        ...
                        printf("avfilter_graph_queue_command----------\n");
...
//     }
    ...
    if (transcode() < 0) {
        printf("transcode return\n");
        exit_program(1);
    } else {
        printf("transcode success\n");
    }
    ti = getutime() - ti;
    if (do_benchmark) {
