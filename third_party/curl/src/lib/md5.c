...
static void SSL_MD5_Init(MD5_CTX *ctx)
{
  MD5_Init(ctx);
}

static void SSL_MD5_Update(MD5_CTX *ctx,
                       const unsigned char *input,
                       unsigned int inputLen)
{
...
static void SSL_MD5_Final(unsigned char digest[16], MD5_CTX *ctx)
{
...
const HMAC_params Curl_HMAC_MD5[] = {
  {
    (HMAC_hinit_func) SSL_MD5_Init,           /* Hash initialization function. */
    (HMAC_hupdate_func) SSL_MD5_Update,       /* Hash update function. */
    (HMAC_hfinal_func) SSL_MD5_Final,         /* Hash computation end function. */
...
const MD5_params Curl_DIGEST_MD5[] = {
  {
    (Curl_MD5_init_func) SSL_MD5_Init,      /* Digest initialization function */
    (Curl_MD5_update_func) SSL_MD5_Update,  /* Digest update function */
    (Curl_MD5_final_func) SSL_MD5_Final,    /* Digest computation end function */
