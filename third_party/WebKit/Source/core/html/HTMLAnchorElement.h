...
class CORE_EXPORT HTMLAnchorElement : public HTMLElement, public LinkLoaderClient, public DOMURLUtils {
  DEFINE_WRAPPERTYPEINFO();
  USING_GARBAGE_COLLECTED_MIXIN(HTMLAnchorElement);
 ...
 private:
  ...
  static const int kPreviousCount = 2;
  static const int kTotalCount = 4;
  ...
  //void adjustAndMark(InlinedGlobalMarkingVisitor) const override { }
  //bool isHeapObjectAlive() const override { return false; }
