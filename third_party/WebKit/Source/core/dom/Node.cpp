...
Node* Node::insertBefore(Node* newChild,
                         ExceptionState& exceptionState) {
  if (isContainerNode())
    return toContainerNode(this)->insertBefore(newChild, exceptionState);
...
Node* Node::removeNode(bool removeFlag, ExceptionState& exceptionState) {
  if (removeFlag) {
    if (ContainerNode* parent = parentNode())
      return parent->removeChild(this, exceptionState);
  }
