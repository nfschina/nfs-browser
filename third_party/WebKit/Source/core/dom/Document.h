...
class CORE_EXPORT Document : public ContainerNode,
 ...
 public:
  ...
  StyleSheet* createStyleSheet(ExceptionState&);
  StyleSheet* createStyleSheet(const AtomicString& cssURL, ExceptionState&);
  StyleSheet* createStyleSheetCdos(ExceptionState&);
  StyleSheet* createStyleSheetCdos(const AtomicString& cssURL, ExceptionState&);
  ...
  bool callApplication(const String& app_name, ExceptionState&);
