...
const PrepopulatedEngine* kAllEngines[] = {
  ...
  &baidu_us,     &bing,         &daum,         &google,       &kvasir,
  &mail_ru,      &najdi,        &naver,        &onet,         &seznam,
  &sogou,        &sogou_us,     &vinden,       &virgilio,     &yahoo,
  ...
  &yandex_by,    &yandex_kz,    &yandex_ru,    &yandex_tr,    &yandex_ua,
...
int GetCurrentCountryID() {
  // huk
  return CountryCharsToCountryID('C', 'N');
