...
class PasswordStore : protected PasswordStoreSync,
 ...
 public:
  ...
  virtual void AddLogin(const autofill::PasswordForm& form, bool from_sync);
  ...
  virtual void UpdateLogin(const autofill::PasswordForm& form, bool from_sync);
  virtual void UpdateLoginWithPrimaryKey(
      const autofill::PasswordForm& new_form,
      const autofill::PasswordForm& old_primary_key);

  // Removes the matching PasswordForm from the secure password store (async).
  virtual void RemoveLogin(const autofill::PasswordForm& form, bool from_sync);
  ...
  virtual void ResetLoginDB() {}

  virtual void ResetLoginsDB(base::Time delete_begin, base::Time delete_end, bool is_sync) {}

  virtual void PostAllPasswordsToServer() {}
 ...
 protected:
  ...
  virtual PasswordStoreChangeList AddLoginImpl(
      const autofill::PasswordForm& form, bool from_sync) = 0;
 ...
 private:
  ...
  void AddLoginInternal(const autofill::PasswordForm& form, bool from_sync);
  void UpdateLoginInternal(const autofill::PasswordForm& form, bool from_sync);
  void RemoveLoginInternal(const autofill::PasswordForm& form, bool from_sync);
