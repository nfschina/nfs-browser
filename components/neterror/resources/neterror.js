...
<if expr="chromeos">
  ...
  diagnoseFrame.innerHTML =
      '<iframe src="nfsbrowser-extension://' + extensionId +
      '/index.html"></iframe>';
</if>
}
...
var err_url = loadTimeData.data_.heading.hostName;

document.querySelector("#input").value = err_url;
...
document.querySelector("#search-bt").addEventListener("click",function(){
