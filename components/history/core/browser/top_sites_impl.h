...
class TopSitesImpl : public TopSites, public HistoryServiceObserver {
 public:
  ...
  // added by wangpp
  bool SetPageCapture(const GURL& url,
                      const base::string16& title,
                      int index,
                      const gfx::Image& capture) override;
  ...
  // added by wangpp
  bool GetPageCapture(const GURL& url,
                      scoped_refptr<base::RefCountedMemory>* bytes) override;
  ...
  void OnCaptureChanged(int index, const GURL& url);
 ...
 private:
  ...
  // added by wangpp
  bool SetPageCaptureEncoded(const GURL& url,
                             const base::string16& title,
                             int index,
