...
class HistoryService : public syncer::SyncableService, public KeyedService {
 public:
  ...
  typedef base::Callback< void(std::vector<int>*)> QueryVisitDateCallback;
  base::CancelableTaskTracker::TaskId QueryActiveHistoryDate(const QueryVisitDateCallback& callback,
                                                     base::CancelableTaskTracker* tracker);
