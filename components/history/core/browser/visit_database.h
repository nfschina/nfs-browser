...
class VisitDatabase {
 public:
  ...
  void GetAllVisitDays(std::vector<int>* visit_dates) ;
...
private:
  static int GetDate(const base::Time& visit_time);

  void AddDailyVisit(VisitRow* visit, VisitSource source);

  void RemoveDailyVisit(const VisitRow& visit);
