...
class OmniboxEditModel {
 public:
  ...
  void set_dropdown_model(OmniboxDropdownModel* dropdown_model) {
    omnibox_controller_->set_dropdown_model(dropdown_model);
  }
  ...
  OmniboxPopupModel* popup_model() const {
   ...
   OmniboxDropdownModel* dropdown_model() const {
    return omnibox_controller_->dropdown_model();
  }
