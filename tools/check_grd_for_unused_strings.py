...
def main():
  ...
  if len(grd_files) == 0:
    ...
    grd_files = [
      ...
      os.path.join(chrome_app_dir, 'theme', 'nfs', 'theme_resources_nfs.grd'),
      ...
      os.path.join(src_dir, 'ui', 'resources', 'nfs', 'ui_resources_nfs.grd'),
      os.path.join(src_dir, 'ui', 'webui', 'resources', 'webui_resources.grd'),
      os.path.join(src_dir, 'ui', 'webui', 'resources', 'nfs', 'webui_resources_nfs.grd'),
