...
SkColor GetAuraColor(NativeTheme::ColorId color_id,
  ...
  static const SkColor kResultsTableHoveredBackground =
      SkColorSetRGB(0xf2, 0xf3, 0xf5);
  static const SkColor kResultsTableSelectedBackground =
      SkColorSetRGB(0xde, 0xec, 0xff);
  ...
  static const SkColor kTooltipBackground = 0xFFFFFFCC; //[zhangyq] use yellow tooltip background color.
  static const SkColor kTooltipTextColor = SkColorSetRGB(0x22, 0x22, 0x22);
  // Tree:
  ...
  switch (color_id) {
    ...
    case NativeTheme::kColorId_ResultsTableHoveredBackground:
      return kResultsTableHoveredBackground; //NFS
    ...
    case NativeTheme::kColorId_ResultsTableSelectedBackground:
      ...
      return kResultsTableSelectedBackground; //NFS
