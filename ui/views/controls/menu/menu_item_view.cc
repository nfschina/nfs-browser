...
namespace {//yana add 160530
	#define SK_ColorMinorText           0xFF666666  //!< Minor Text SkColor value
	#define SK_ColorMinorTextDIS        0xFF999999
}
...
void MenuItemView::PaintButton(gfx::Canvas* canvas, PaintButtonMode mode) {
  ...
  //yana modify 160531
  if (delegate && delegate->GetForegroundColor(enabled(),
                                               render_selection,
