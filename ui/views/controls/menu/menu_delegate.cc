...
namespace {//yana add 20160531
	#define SK_ColorFont        0xFF333333  //!< font SkColor value
	#define SK_ColorFontDIS     0xFF999999  //!< hover background SkColor value
	#define SK_ColorHoverBG     0xFFDEECFF  //!< disabled hover background SkColor value
}
...
//yana modify 160530
bool MenuDelegate::GetBackgroundColor(int is_enabled/*command_id*/,
                                      bool is_hovered,
                                      SkColor* override_color) const {
	if(is_hovered){
		*override_color=SK_ColorHoverBG;
		return true;
	}
	else{
		return false;
...
//yana modify 160530
bool MenuDelegate::GetForegroundColor(int is_enabled/*command_id*/,
                                      bool is_hovered,
                                      SkColor* override_color) const {
  	if(is_enabled) {
		*override_color=SK_ColorFont;
  	}else{
		*override_color=SK_ColorFontDIS;
	}
	return true;
}
