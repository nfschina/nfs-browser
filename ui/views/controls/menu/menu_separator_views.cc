...
namespace {//yana add 20160531
	#define SK_ColorSEPARETOR   0xFFDDDDDD
	#define SeparatorLeftMargin 10
}
...
gfx::Rect MenuSeparator::GetPaintBounds() {
  ...
  switch (type_) {
	...
	//yana modify 160531
  gfx::Rect paint_rect(SeparatorLeftMargin, pos, width()-SeparatorLeftMargin, separator_thickness);
