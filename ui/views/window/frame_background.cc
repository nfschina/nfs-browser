...
FrameBackground::FrameBackground()
    : frame_color_(0),
      top_area_height_(0),
      left_edge_(new gfx::ImageSkia()),
      top_edge_(new gfx::ImageSkia()),
      right_edge_(new gfx::ImageSkia()),
      bottom_edge_(new gfx::ImageSkia()),
      top_left_corner_(new gfx::ImageSkia()),
      top_right_corner_(new gfx::ImageSkia()),
      bottom_left_corner_(new gfx::ImageSkia()),
      bottom_right_corner_(new gfx::ImageSkia()),
