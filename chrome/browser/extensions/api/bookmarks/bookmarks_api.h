...
class BookmarksNFSImportFunction : public BookmarksIOFunction {
 public:
  DECLARE_EXTENSION_FUNCTION("bookmarks.NFSImport", BOOKMARKS_NFSIMPORT)
 ...
 private:
  ~BookmarksNFSImportFunction() override {}
