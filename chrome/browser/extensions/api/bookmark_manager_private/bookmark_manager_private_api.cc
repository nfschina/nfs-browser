...
BookmarkManagerPrivateGetStringsFunction::Run() {
  ...
  localized_strings->SetString("add_folder",
      l10n_util::GetStringUTF16(IDS_CDOS_BOOKMARK_MANAGER_ADD_FOLDER));
  localized_strings->SetString("add_bookmark",
      l10n_util::GetStringUTF16(IDS_CDOS_BOOKMARK_MANAGER_ADD_BOOKMARK));
  localized_strings->SetString("import_bookmark",
      l10n_util::GetStringUTF16(IDS_CDOS_BOOKMARK_MANAGER_IMPORT_BOOKMARK));
  localized_strings->SetString("export_bookmark",
      l10n_util::GetStringUTF16(IDS_CDOS_BOOKMARK_MANAGER_EXPORT_BOOKMARK));
