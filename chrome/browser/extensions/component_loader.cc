...
#if defined(ENABLE_NFS_VIDEO_EXTENSIONS)
  // Nfs popup video window
  Add(IDR_CDOS_VIDEO_MANIFEST,
      base::FilePath(FILE_PATH_LITERAL("nfs_video")));
#endif

#if defined(OS_LINUX)
  //Add(IDR_MALICIOUS_URL_CHECK_MANIFEST,
  //    base::FilePath(FILE_PATH_LITERAL("malicious_url_check")));
#endif

  Add(IDR_ARP_COMPATIBLE_MANIFEST,
      base::FilePath(FILE_PATH_LITERAL("arp_compatible")));

  Add(IDR_DOM_COMPATIBLE_MANIFEST,
      base::FilePath(FILE_PATH_LITERAL("dom_compatible")));

  Add(IDR_COPYSEARCH_MANIFEST,
      base::FilePath(FILE_PATH_LITERAL("copy_search")));
}
