...
bool IsComponentExtensionWhitelisted(int manifest_resource_id) {
  switch (manifest_resource_id) {
    ...
    //Nfs video popup window
    case IDR_CDOS_VIDEO_MANIFEST:
#endif

    // case IDR_MALICIOUS_URL_CHECK_MANIFEST:
    case IDR_ARP_COMPATIBLE_MANIFEST:
    case IDR_DOM_COMPATIBLE_MANIFEST:
    case IDR_COPYSEARCH_MANIFEST:
      return true;
  }
