...
class PreinstallExtensionService;
...
class ExtensionService
 ...
 private:
  ...
  // huk 加载预置扩展
  void PreInstallExtensions(const std::string& id);

  bool IsPreInstallExtension(const std::string& id);
  ...
  std::unique_ptr<PreinstallExtensionService> preinstall_extension_service_;
