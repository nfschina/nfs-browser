...
const FeatureEntry::Choice kSSLVersionMinChoices[] = {
    {IDS_GENERIC_EXPERIMENT_CHOICE_DEFAULT, "", "" },
    {IDS_FLAGS_SSL_VERSION_MIN_TLS1, switches::kSSLVersionMin, "tls1"}
};
...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"ssl-version-min", IDS_FLAGS_SSL_VERSION_MIN_NAME,
     IDS_FLAGS_SSL_VERSION_MIN_DESCRIPTION, kOsAll,
