...
class ThreeDAPIInfoBarDelegate : public ConfirmInfoBarDelegate {
 ...
 private:
  ...
  base::WeakPtrFactory<ThreeDAPIInfoBarDelegate> weak_ptr_factory_;
...
ThreeDAPIInfoBarDelegate::ThreeDAPIInfoBarDelegate(
  ...
  content::BrowserThread::PostDelayedTask(
      ...
      base::Bind(&ThreeDAPIInfoBarDelegate::CancelAsyn, weak_ptr_factory_.GetWeakPtr()),
...
void ThreeDAPIInfoBarDelegate::CancelAsyn() {
  Cancel();
}
