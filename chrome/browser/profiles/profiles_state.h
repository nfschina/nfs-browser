...
void RemoveBrowsingDataForProfile_RemoveMask(const base::FilePath& profile_path, const int period_selected,const int remove_mask,const int original_mask); //wdg add
