...
std::vector<base::FilePath> OffTheRecordProfileImpl::download_selected_directorys() {
...
void OffTheRecordProfileImpl::set_download_selected_directory(const base::FilePath& path) {
