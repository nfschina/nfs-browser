...
class ThemeProperties {
 public:
  ...
  enum OverwritableByUserThemeProperty {
    ...
    COLOR_DOWNLOAD_FRAME,
    COLOR_DOWNLOAD_FRAME_INACTIVE,
    COLOR_WEB_VIDEO_FRAME,
    COLOR_WEB_VIDEO_FRAME_INACTIVE,
    COLOR_TAB_BLUR_ACTIVE,
    COLOR_TAB_BLUR_INACTIVE,
    COLOR_NEW_TAB_BUTTON_BLUR_NORMAL,
    COLOR_NEW_TAB_BUTTON_BLUR_PRESS,
    COLOR_NEW_TAB_BUTTON_BLUR_HOVER,
    COLOR_TOOLBAR_BLUR,
  ...
  static std::string OffsetToString(int offset_x, int offset_y);
  ...
  static int StringToStyle(const std::string& style);
