...
class BrowserThemePack : public CustomThemeSupplier {
 public:
  ...
  static void PostBuildFromExtension(const extensions::Extension* extension);
 ...
 private:
  ...
  static void BuildFromExtensionOnFileThread(const extensions::Extension* extension);
  static  void NotifyThemeInfo(scoped_refptr<BrowserThemePack> pack,
        const extensions::Extension* extension);
