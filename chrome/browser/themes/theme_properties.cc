...
const SkColor kDefaultColorFrame[] = {
    SkColorSetRGB(0xC3, 0xC3, 0xC4), SkColorSetRGB(220, 220, 220)};
const SkColor kDefaultColorFrameInactive[] = {
    SkColorSetRGB(0xCD, 0xCD, 0xCE), SkColorSetRGB(220, 220, 220)};
const SkColor kDefaultDownloadColorFrame = SK_ColorWHITE;
const SkColor kDefaultDownloadColorFrameInactive = SK_ColorWHITE;
const SkColor kDefaultWebVideoColorFrame = SkColorSetRGB(51, 51, 51);
const SkColor kDefaultWebVideoColorFrameInactive = SkColorSetRGB(51, 51, 51);
#endif
...
#else
// huk toolbar color for linux and windows
const SkColor kDefaultColorToolbar[] = {SkColorSetRGB(0xF1, 0xF9, 0xFF),
                                        SkColorSetRGB(0xF1, 0xF9, 0xFF)};
const SkColor kDefaultColorToolbarIncognito[] = {
    SkColorSetRGB(0xF1, 0xF9, 0xFF), SkColorSetRGB(0xF1, 0xF9, 0xFF)};
#endif  // OS_MACOSX
...
const SkColor kDefaultColorNewTabButtonCross = SkColorSetRGB(0x33, 0x33, 0x33); //wangdq

const SkColor kDefaultColorToolbarBlur =  SK_ColorTRANSPARENT;
...
//static
std::string ThemeProperties::OffsetToString(int offset_x, int offset_y) {
  return base::IntToString(offset_x) + "px " + base::IntToString(offset_y) + "px";
}
...
SkColor ThemeProperties::GetDefaultColor(int id, bool otr) {
  ...
  switch (id) {
    ...
    case COLOR_DOWNLOAD_FRAME:
      return kDefaultDownloadColorFrame;
    case COLOR_DOWNLOAD_FRAME_INACTIVE:
      return kDefaultDownloadColorFrameInactive;
    case COLOR_WEB_VIDEO_FRAME:
      return kDefaultWebVideoColorFrame;
    case COLOR_WEB_VIDEO_FRAME_INACTIVE:
      return kDefaultWebVideoColorFrameInactive;
    ...
    case COLOR_NEWTAB_BUTTON_CROSS:   // wangdq
      return kDefaultColorNewTabButtonCross;

    case COLOR_TAB_BLUR_ACTIVE:
    case COLOR_TAB_BLUR_INACTIVE:
    case COLOR_NEW_TAB_BUTTON_BLUR_NORMAL:
    case COLOR_NEW_TAB_BUTTON_BLUR_PRESS:
    case COLOR_NEW_TAB_BUTTON_BLUR_HOVER:
    case COLOR_TOOLBAR_BLUR:
      return kDefaultColorToolbarBlur;
