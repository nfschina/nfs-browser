...
/**
 * Opens a new window with nfsbrowser://slow_trace, downloading performance data.
 */
function openSlowTraceWindow() {
  chrome.app.window.create(
      'nfsbrowser://slow_trace/tracing.zip#' + feedbackInfo.traceId);
}
      ...
      chrome.feedbackPrivate.getStrings(function(strings) {
        ...
        if ($('histograms-url')) {
          ...
          $('histograms-url').onclick =
              windowOpener(STATS_WINDOW_ID, 'nfsbrowser://histograms');
        }
