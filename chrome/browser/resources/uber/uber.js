...
cr.define('uber', function() {
  ...
  /**
   * Changes the path past the page title (i.e. nfsbrowser://chrome/settings/(.*)).
  ...
  function showPage(pageId, historyOption, path) {
    ...
    $('favicon').href = 'nfsbrowser://theme/' + dataset.favicon;
    $('favicon2x').href = 'nfsbrowser://theme/' + dataset.favicon + '@2x';
