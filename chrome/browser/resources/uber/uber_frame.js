...
cr.define('uber_frame', function() {
  ...
  function onNavItemClicked(e) {
    ...
    if (e.currentTarget.getAttribute('override') == 'yes') {
      window.open('nfsbrowser://' + e.currentTarget.getAttribute('controls'),
          '_blank');
      return;
    }
  ...
  /**
   * Handles postMessage from nfsbrowser://chrome.
  ...
  function showNavItems() {
    /*  add  by dg for disable the history and extension page in chrome://settings 
    ...
    $('history').hidden = loadTimeData.getBoolean('hideHistory');*/
     ...
     var hideSettingsAndHelp = true;
     $('settings').hidden = hideSettingsAndHelp;
    $('help').hidden = hideSettingsAndHelp;
    $('extensions').hidden = loadTimeData.getBoolean('hideExtensions');
    $('extensions').hidden = hideSettingsAndHelp;
    $('history').hidden = loadTimeData.getBoolean('hideHistory');
     $('history').hidden  = hideSettingsAndHelp;
  }
