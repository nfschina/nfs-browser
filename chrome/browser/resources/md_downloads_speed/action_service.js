...
cr.define('downloads', function() {
  ...
  ActionService.prototype = {
    ...
    /** Instructs the browser to show the pop wnd for create new item. */
    newItem: function() {
      chrome.send('newItem');
    },
    ...
    /** Instructs the browser to open the setting page. */
    openSetting: function() {
      chrome.send('openSetting');
    },

    /** Show the right menu */
    rightMenu: function(id, x, y) {
      chrome.send('rightMenu', [id, x, y]);
    },
