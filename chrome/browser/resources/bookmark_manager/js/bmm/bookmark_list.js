...
/*
      ...
      var editEl = this.ownerDocument.createElement('span');
      editEl.className = 'list-edit';
      editEl.style.background = 'url(images/bookmark_manager_icons.png) 2px -143px';


      var removeEl = this.ownerDocument.createElement('span');
      removeEl.className = 'list-remove';
      removeEl.style.background = 'url(images/bookmark_manager_icons.png) -28px -144px';

      if (bmm.isFolder(bookmarkNode)) {
        this.className = 'folder';
      } else {
        // labelEl.style.backgroundImage = getFaviconImageSet(bookmarkNode.url);
        labelEl.style.backgroundImage = 'url(nfsbrowser://favicon/' + bookmarkNode.url + ')';
...
*/
      ...
      var urlEl = this.ownerDocument.createElement('div');
      urlEl.className = 'url';
      var editEl = this.ownerDocument.createElement('div');
      editEl.className = 'list-edit';
      editEl.style.background = 'url(images/bookmark_manager_icons.png) 2px -143px';
      var removeEl = this.ownerDocument.createElement('div');
      removeEl.className = 'list-remove';
      removeEl.style.background = 'url(images/bookmark_manager_icons.png) -28px -144px';
      ...
      if (bmm.isFolder(bookmarkNode)) {
        ...
        //     cr.isMac ?
        //         'nfsbrowser://theme/IDR_BOOKMARK_BAR_FOLDER' :
        //         'nfsbrowser://theme/IDR_FOLDER_CLOSED');
      } else {
