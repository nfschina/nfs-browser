...
#if !defined(OS_CHROMEOS)
  if (! base::CommandLine::ForCurrentProcess()->HasSwitch(switches::kPasswordStore))
    base::CommandLine::ForCurrentProcess()->AppendSwitchASCII(switches::kPasswordStore, "basic");
