...
class ChromeDownloadManagerDelegate
 ...
 public:
  ...
  int  GetDownloadMaxSpeed() override;
  base::FilePath GetUserDataPath() override;
  bool ShouldNoteDownloadQuit() const override;
  bool ShouldContinueLastDownload() const override;
  bool ShouldPromptForDownload() const override;
  ...
  std::string GetReferrerCharset() const override;
  std::string GetDownloadDefaultFileName() const override;
  void DownloadCompleted(content::DownloadItem* download) override;
  void ShowCreateDownload(content::WebContents* web_contents) override;
  void ShowDownloadRightMenu(content::DownloadItem* download,
    content::WebContents* web_contents, int point_x, int point_y) override;
  ...
  // Should update the download progressing
  bool ShouldDownloadUpdate() override;
 ...
 private:
  ...
  void LoadIcon(content::DownloadItem* download);

  void OnExtractIconComplete(gfx::Image* icon_bitmap);

  void OnDownloadCompleteBubbleClosed(
        DownloadFeedbackView::CloseReason reson, bool no_remind, uint32_t);

  void DeleteFileDone(bool success);
  ...
  DownloadFeedbackView::DownloadInfo download_bubble_info_;
