...
void AllDownloadItemNotifier::OnDownloadReCreated(
    content::DownloadManager* manager,
    content::DownloadItem* item) {
  observer_->OnDownloadReCreated(manager, item);
}

void AllDownloadItemNotifier::OnDownloadPromptd(
    content::DownloadManager* manager,
    content::DownloadCreateInfo* info) {
  observer_->OnDownloadPromptd(manager, info);
}
