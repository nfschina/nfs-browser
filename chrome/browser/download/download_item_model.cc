...
base::string16 DownloadItemModel::FormatBytesWithUnits(int64_t size) {
  ui::DataUnits amount_units = ui::GetByteDisplayUnits(size);
  base::string16 simple_size = ui::FormatBytesWithUnits(size, amount_units, true);
  return simple_size;
}

base::string16 DownloadItemModel::GetPauseStatusString() const {
