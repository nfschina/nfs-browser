...
DownloadShelfContextMenu::DownloadShelfContextMenu(DownloadItem* download_item, DownloadManager* download_manager)
    : download_item_(download_item),
      download_commands_(new DownloadCommands(download_item, download_manager)) {
...
base::string16 DownloadShelfContextMenu::GetLabelForCommandId(
  ...
  switch (static_cast<DownloadCommands::Command>(command_id)) {
    ...
    case DownloadCommands::ANNOTATE:
      ...
      NOTREACHED();
      break;
    case DownloadCommands::DELETE_TASK:
      id = IDS_DOWNLOAD_MENU_DELETE_TASK;
      break;
    case DownloadCommands::DELETE_TASK_DOWNLOAD:
      id = IDS_DOWNLOAD_MENU_DELETE_TASK_DOWNLOAD;
      break;
    case DownloadCommands::MOVE_FOLDER:
      id = IDS_DOWNLOAD_MENU_MOVE_FOLDER;
      break;
    case DownloadCommands::COPY_DOWNLOAD_LINK:
      id = IDS_DOWNLOAD_MENU_COPY_DOWNLOAD_LINK;
      break;
    case DownloadCommands::DOWNLOAD_AGAIN:
      id = IDS_DOWNLOAD_MENU_DOWNLOAD_AGAIN;
      break;
  }
  CHECK(id != -1);
...
ui::SimpleMenuModel* DownloadShelfContextMenu::GetFinishedMenuModel() {
  ...
  finished_download_menu_model_->AddItem(
      DownloadCommands::DELETE_TASK,
      GetLabelForCommandId(DownloadCommands::DELETE_TASK));
  finished_download_menu_model_->AddItem(
      DownloadCommands::DELETE_TASK_DOWNLOAD,
      GetLabelForCommandId(DownloadCommands::DELETE_TASK_DOWNLOAD));
  finished_download_menu_model_->AddItem(
      DownloadCommands::DOWNLOAD_AGAIN,
      GetLabelForCommandId(DownloadCommands::DOWNLOAD_AGAIN));
  finished_download_menu_model_->AddSeparator(ui::NORMAL_SEPARATOR);
  #if 0 //wdq
  finished_download_menu_model_->AddItem(
      DownloadCommands::MOVE_FOLDER, 
      GetLabelForCommandId(DownloadCommands::MOVE_FOLDER));
  #endif
  finished_download_menu_model_->AddItem(
      DownloadCommands::COPY_DOWNLOAD_LINK, 
      GetLabelForCommandId(DownloadCommands::COPY_DOWNLOAD_LINK));
...
ui::SimpleMenuModel* DownloadShelfContextMenu::GetInterruptedMenuModel() {
  ...
  interrupted_download_menu_model_->AddItem(
      DownloadCommands::DOWNLOAD_AGAIN, GetLabelForCommandId(DownloadCommands::DOWNLOAD_AGAIN));
#if defined(OS_WIN)
