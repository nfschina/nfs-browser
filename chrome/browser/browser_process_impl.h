...
class BrowserProcessImpl : public BrowserProcess,
 ...
 public:
  ...
  CheckurlManager* check_url_manager() override;
 ...
 private:
  ...
  void CreateCheckurlManager();//add by wangn
  void DBPathTransf();//add by wangn
  sqlite3* CreateMurl();//add by wangn
  bool IsTableExist(const char*,sqlite3*);//add by wangn
  ...
  // added by wangpp
#if defined(OS_WIN)
  void CheckNewVersionWin();
#elif defined(OS_LINUX)
  void CheckNewVersionLinux();
#endif
  ...
  bool created_checkurl_manager_;//add by wangn
  std::unique_ptr<CheckurlManager> check_url_manager_;
