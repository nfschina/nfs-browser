...
bool CookiesTreeModelUtil::GetCookieTreeNodeDictionary(
  ...
  switch (node.GetDetailedInfo().node_type) {
    case CookieTreeNode::DetailedInfo::TYPE_HOST: {
      ...
      dict->SetString(kKeyIcon, "nfsbrowser://theme/IDR_BOOKMARK_BAR_FOLDER");
#endif
      break;
    }
    case CookieTreeNode::DetailedInfo::TYPE_COOKIE: {
      dict->SetString(kKeyType, "cookie");
      dict->SetString(kKeyIcon, "nfsbrowser://theme/IDR_COOKIE_ICON");
    ...
    case CookieTreeNode::DetailedInfo::TYPE_DATABASE: {
      ...
      dict->SetString(kKeyIcon, "nfsbrowser://theme/IDR_COOKIE_STORAGE_ICON");
