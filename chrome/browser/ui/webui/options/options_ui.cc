...
void OptionsUIHTMLSource::AddReplacements(
  ...
  localized_strings->SetString("open_tab",
      l10n_util::GetStringUTF16(IDS_OPEN_TAB));
  localized_strings->SetString("copy_tab",
      l10n_util::GetStringUTF16(IDS_COPY_TAB));
  localized_strings->SetString("open_homepage",
      l10n_util::GetStringUTF16(IDS_OPEN_HOMEPAGE));
  localized_strings->SetString("close_tab",
      l10n_util::GetStringUTF16(IDS_CLOSE_TAB));
  localized_strings->SetString("close_all_tab",
      l10n_util::GetStringUTF16(IDS_CLOSE_ALL_TAB));
  localized_strings->SetString("reopen_the_last_tab",
      l10n_util::GetStringUTF16(IDS_REOPEN_LAST_TAB));
  localized_strings->SetString("switch_to_previous_tab",
      l10n_util::GetStringUTF16(IDS_SWITCH_TO_PREVIOUS_TAB));
  localized_strings->SetString("switch_to_next_tab",
      l10n_util::GetStringUTF16(IDS_SWITCH_TO_NEXT_TAB));
  localized_strings->SetString("open_new_window",
      l10n_util::GetStringUTF16(IDS_OPEN_NEW_WINDOW));
  localized_strings->SetString("select_address_bar",
      l10n_util::GetStringUTF16(IDS_SELECT_ADDRESS_BAR));
  localized_strings->SetString("open_new_stealth_window",
      l10n_util::GetStringUTF16(IDS_OPEN_STEALTH_WINDOW));
  localized_strings->SetString("dropdown_list",
      l10n_util::GetStringUTF16(IDS_DROPDOWN_LIST));
  localized_strings->SetString("stop",
      l10n_util::GetStringUTF16(IDS_STOP));
  localized_strings->SetString("refresh",
      l10n_util::GetStringUTF16(IDS_REFRESH));
  localized_strings->SetString("force_refresh",
      l10n_util::GetStringUTF16(IDS_FORCE_REFRESH));
  localized_strings->SetString("page_zoom",
      l10n_util::GetStringUTF16(IDS_PAGE_ZOOM));
  localized_strings->SetString("page_shrink",
      l10n_util::GetStringUTF16(IDS_PAGE_SHRINK));
  localized_strings->SetString("restore_page",
      l10n_util::GetStringUTF16(IDS_RESTORE_PAGE));
  localized_strings->SetString("full_screen",
      l10n_util::GetStringUTF16(IDS_FULL_SCREEN));
  localized_strings->SetString("save_current_page",
      l10n_util::GetStringUTF16(IDS_SAVE_CURRENT_PAGE));
  localized_strings->SetString("save_pgae_as_picture",
      l10n_util::GetStringUTF16(IDS_SAVE_PAGE_AS_PICTURE));
  localized_strings->SetString("print",
      l10n_util::GetStringUTF16(IDS_PAGE_PRINT));
  localized_strings->SetString("open_file",
      l10n_util::GetStringUTF16(IDS_OPEN_FILE));
  localized_strings->SetString("page_search",
      l10n_util::GetStringUTF16(IDS_PAGE_SEARCH));
  localized_strings->SetString("open_downloadmanager",
      l10n_util::GetStringUTF16(IDS_OPEN_DOWNLOADMANGER));
  localized_strings->SetString("view_history",
      l10n_util::GetStringUTF16(IDS_VIEW_HISTORY));
  localized_strings->SetString("clear_traces",
      l10n_util::GetStringUTF16(IDS_CLEAR_TRACES));
  localized_strings->SetString("add_bookmark",
      l10n_util::GetStringUTF16(IDS_ADD_BOOKMARK));
  localized_strings->SetString("show_hide_bookmarkbar",
      l10n_util::GetStringUTF16(IDS_SHOW_HIDE_BOOKMARKBAR));
  localized_strings->SetString("developer_tool",
      l10n_util::GetStringUTF16(IDS_DEVELOPER_TOOL));
  localized_strings->SetString("click_to_modify_shortcut_keys",
      l10n_util::GetStringUTF16(IDS_CLICK_MODIFY_SHORTCUT_KEYS));
  localized_strings->SetString("system_shortcuts_not_editable",
      l10n_util::GetStringUTF16(IDS_SYS_SHORTCUT_NOT_EDITABLE));
  localized_strings->SetString("delete_shortcut",
      l10n_util::GetStringUTF16(IDS_DELETE_SHORTCUT));
  localized_strings->SetString("restore_default_success",
      l10n_util::GetStringUTF16(IDS_RESTORE_DEFAULT_SUCESS));
  localized_strings->SetString("not_allow_Chinese",
      l10n_util::GetStringUTF16(IDS_NOT_ALLOW_CHINESE));
  localized_strings->SetString("not_allow_system_shortcut",
      l10n_util::GetStringUTF16(IDS_NOT_ALLOW_SYS_SHORTCUT));
  localized_strings->SetString("this_shortcut_already",
      l10n_util::GetStringUTF16(IDS_THIS_SHORTCUT_ALREADY));
  localized_strings->SetString("uesd",
      l10n_util::GetStringUTF16(IDS_USED));
  localized_strings->SetString("uesd_reset",
      l10n_util::GetStringUTF16(IDS_USED_RESET));
  localized_strings->SetString("this_shortcut_already_used_by_system",
      l10n_util::GetStringUTF16(IDS_THIS_SHORTCUT_ALREADY_USED_BY_SYS));
  localized_strings->SetString("this_shortcut_already_used_by_system_reset",
      l10n_util::GetStringUTF16(IDS_THIS_SHORTCUT_ALREADY_USED_BY_SYS_RESET));
}
