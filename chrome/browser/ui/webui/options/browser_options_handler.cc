...
#include "base/memory/ptr_util.h"  //add by wdg
...
BrowserOptionsHandler::~BrowserOptionsHandler() {
 ...
 if( cache_select_folder_dialog_.get())
  cache_select_folder_dialog_->ListenerDestroyed();
...
void BrowserOptionsHandler::GetLocalizedValues(base::DictionaryValue* values) {
  ...
  static OptionsStringResource resources[] = {
    ...
    { "addressbar", IDS_OPTIONS_ADDRESSBAR },   //地址栏
    { "addressbar_autofill", IDS_OPTIONS_ADDRESSBAR_AUTO_FILL },  //地址栏自动填充
    { "addressbar_showhistory", IDS_OPTIONS_ADDRESSBAR_SHOW_HISTORY },  // 地址栏显示历史记录
    { "addressbar_showbookmark", IDS_OPTIONS_ADDRESSBAR_SHOW_BOOKMARK },  // 地址栏显示书签
    { "addressbar_copyclip", IDS_OPTIONS_ADDRESSBAR_COPY_CLIP },  // 地址栏复制粘帖
    { "addressbar_compatibleMode", IDS_OPTIONS_ADDRESSBAR_COMPATIBLE_MODE },  // 地址栏显示切换兼容模式图标
    { "enablePrivacyProtocal", IDS_OPTIONS_ENABLE_PRIVACY_PROTOCAL },  // privacy protocal
    { "enableGPU", IDS_OPTIONS_ENABLE_GPU },
    ...
    { "browsermode_speed", IDS_OPTIONS_BROWSER_MODE_SPEED },   //浏览器模式 极速
    { "browsermode_safe", IDS_OPTIONS_BROWSER_MODE_SAFE },  //安全浏览模式
    { "browsermode_both", IDS_OPTIONS_BROWSER_MODE_BOTH },  // 兼容浏览模式
    //setting page
    {  "generalSetting", IDS_OPTIONS_GENERAL_SETTING },
    {  "tabSetting", IDS_OPTIONS_TAB_SETTING },
    {  "downloadSetting", IDS_OPTIONS_DOWNLOAD_SETTING },
    {  "keyboardSetting", IDS_OPTIONS_KEYBOARD_SETTING },
    {  "moreSetting", IDS_OPTIONS_MORE_SETTING },

    { "blank tabs", IDS_OPTIONS_BLANK_TABS },     //新建空白页面
    { "special tabs", IDS_OPTIONS_SPECIAL_TABS },   //新建主页面
    { "tabsettingsGroupName", IDS_OPTIONS_TABS_SETTINGS},  // 标签页设置
    { "tabsdoubleclicktabs", IDS_OPTIONS_TABS_DOUBLE_CLICK},  // 标签页设置
    { "closereopenlasttabs", IDS_OPTIONS_TABS_REOPEN_LAST_TAB},  // 关闭窗口内最后一个标签时，自动打开新标签页
    { "linktonewtabs", IDS_OPTIONS_LINK_NEW },     //跳转到新页面
    { "openinbackround", IDS_OPTIONS_OPEN_IN_BACKGROUND},   //新建主页面
    { "promptinnewwindow", IDS_OPTIONS_TABS_IN_NEWWINDOW},  // 标签页设置
    { "enbaletabpreview", IDS_OPTIONS_TABS_ENABLE_PREVIEW},  // 标签页设置
    { "sectionBrowsingMode", IDS_OPTIONS_BROWSER_MODE},
    { "resetShortcuts", IDS_OPTIONS_RESET_SHORT_CUT},
    { "closetabsetting", IDS_OPTIONS_CLOSE_TABS_SETTING },
    { "switch_to_left", IDS_OPTIONS_TABS_SWITCH_TO_LEFT },
    { "switch_to_right", IDS_OPTIONS_TABS_SWITCH_TO_RIGHT },
    { "smart_switch", IDS_OPTIONS_TABS_SMART_SWITCH },
    { "open_form_right", IDS_OPTIONS_TABS_FORM_RIGHT },
    { "open_form_all_right", IDS_OPTIONS_TABS_FORM_ALL_RIGHT },

    { "TabPreviewName", IDS_TAB_PREVIEW },
    { "always open tab preview", IDS_OPTIONS_OPEN_TAB_PREVIEW },
    { "don't open tab preview", IDS_OPTIONS_NOT_OPEN_TAB_PREVIEW },
    { "open tab preview when tab index less than", IDS_OPTIONS_LOT_TAB_PREVIEW },
    { "pixel", IDS_INDEX_PIXEL },
    { "tab_index_note", IDS_OPTIONS_TAB_INDEX_NOTE },

    { "default_search_engine",
      IDS_RESET_PROFILE_SETTINGS_DSE },  //默认搜索引擎
    { "close_switch_to",                //关闭后切换至
      IDS_OPTIONS_TABS_CLOSE_SWITCH_TO },
    { "open_tabs_settings_head",
      IDS_OPTIONS_OPEN_SETTINGS_HEAD },  //打开标签页
    { "when_open_tabs",
      IDS_OPTIONS_OPEN_SETTINGS_ACTION },  //打开标签页时
    { "others",
      IDS_OPTIONS_OPEN_OTHER_HEAD },  //其他：
    { "download_speed_note",
      IDS_OPTIONS_DOWNLOAD_SPEED_NOTES},  // KB/S (输入1-9999的整数)
    { "change_cache_path_notes",
      IDS_OPTIONS_CACHE_PATH_CHANGE_NOTES},
    { "change_cache_path_notes_1",
      IDS_OPTIONS_CACHE_PATH_CHANGE_NOTES_1},    //     MB时，自动清理
    { "change_cache_path_notes_2",
      IDS_OPTIONS_CACHE_PATH_CHANGE_NOTES_2},  //（输入100-9999的整数)
    // 更改缓存目录，将清空现有缓存，重启后生效
    { "change_cache_path_notes_3",
      IDS_OPTIONS_CACHE_PATH_CHANGE_NOTES_3},
    //  定期清理缓存,可有效节省硬盘空间,并可修复页面异常等问题

    //downlaod
    { "Download_Not_Limit_Speed", IDS_OPTIONS_DOWNLOAD_NOT_LIMIT_SPEED },
    { "Download_MaxSpeed", IDS_OPTIONS_DOWNLOAD_MAX_SPEED },
    { "Download_Limit_Speed", IDS_OPTIONS_DOWNLOAD_LIMIT_SPEED },
    { "Donwnload_task_notice", IDS_OPTIONS_DOWNLOAD_QUIT_NOTICE },
    { "Download_prompt_window", IDS_OPTIONS_DOWNLOAD_PROMPT_WINDOW },
    { "Download_Voice_Notice", IDS_OPTIONS_DOWNLOAD_VOICE_NOTICE },
    { "Download_In_Last_Session", IDS_OPTIONS_DOWNLOAD_CONTINUE_LAST_SESSION },

    //shortcut setting
    { "open_following_shortcut_keys", IDS_OPTIONS_ENABLE_SHORT_CUT },
    { "restore_default_shortcut_keys", IDS_OPTIONS_RESET_SHORT_CUT },
    { "browseClass", IDS_OPTIONS_BROWSER_CLASS },
    { "tabClass", IDS_OPTIONS_TABS_CLASS },
    { "toolClass", IDS_OPTIONS_TOOLS_CLASS },
    { "action_shortcut", IDS_OPTIONS_ACTION_SHORT_CUT },
    { "Shortcut_and_implement", IDS_OPTIONS_SHORT_CUT },
    //{ "(Press the shortcut key to modify)", IDS_OPTIONS_SHORTCUT_IMPLEMENT },

    { "CacheSettings", IDS_OPTIONS_CACHE_SETTINGS },
    { "CacheDirSettings", IDS_OPTIONS_CACHE_DIR_SETTINGS },
    { "CacheDirReset", IDS_OPTIONS_CACHE_RESET_BUTTON },
    { "CacheAutoClear", IDS_OPTIONS_CACHE_AUTO_CLEAR },
    ...
    { "downloadLocationGroupName", IDS_OPTIONS_DOWNLOADLOCATION_GROUP_NAME },
     { "Enable Browser Check", IDS_OPTIONS_ENABLE_BROWSER_CHECK },    //允许浏览器检测
    ...
    { "prerenderSettingsSectionTitle",IDS_PRERENDER_SETTINGSTITLE},
    { "enableclickprerender",IDS_OPTIONS_ENABLE_CLICK_PRERENDER},
    { "enablemouseoverprerender",IDS_OPTIONS_ENABLE_MOUSE_OVER_PRERENDER},
    ...
    { "startupShowLastSessionList", IDS_OPTIONS_STARTUP_SHOW_LAST_SESSION_LIST },
    ...
    { "toolbarShowSearchBar", IDS_OPTIONS_TOOLBAR_SHOW_SEARCH_BAR },
    { "toolbarShowBookmarksBar", IDS_OPTIONS_TOOLBAR_SHOW_BOOKMARKS_BAR },
    { "toolbarShowHomeButton", IDS_OPTIONS_TOOLBAR_SHOW_HOME_BUTTON },
    { "toolbarShowToolBar", IDS_OPTIONS_TOOLBAR_SHOW_TOOL_BAR },
    { "translateEnableTranslate",
      IDS_OPTIONS_TRANSLATE_ENABLE_TRANSLATE },
    { "CloseBrowser", IDS_OPTIONS_CLOSE_BROWSER },    //关闭多标签页提示
    { "CloseMultiTabsNotice", IDS_OPTIONS_CLOSE_BROWSER_NOTICE },    //关闭多标签页提示
    { "CloseMultiTabsClearData", IDS_OPTIONS_CLOSE_BROWSER_CLEAR_DATA },    //关闭多标签页提示
    { "webToolbarGroupName", IDS_OPTIONS_WEB_TOOLBAR},    //网页工具条
    { "videoToolbarEnabled", IDS_OPTIONS_VIDEO_TOOLBAR},    //视频工具条
    { "copySearchEnabled", IDS_OPTIONS_COPY_SEARCH},    //复制搜索工具条
#if defined(OS_CHROMEOS)
...
#endif  // defined(ENABLE_SERVICE_DISCOVERY)
    { "updateSettingsSectionTitle", IDS_UPDATE_SETTINGS_SECTION_TITLE },
    { "autoUpdateLatestVersion", IDS_AUTO_UPDATE_TO_THE_LAST_VERSION },
    { "sectionLanguage", IDS_OPTIONS_SETTINGS_LANGUAGES_LANGUAGES },
    { "language_en", IDS_LANGUAGE_SETTINGS_LAN_EN },
    { "language_zh-CN", IDS_LANGUAGE_SETTINGS_LAN_ZH_CN },
    { "language_zh-TW", IDS_LANGUAGE_SETTINGS_LAN_ZH_TW },
    { "language_setting_tip", IDS_LANGUAGE_SETTINGS_TIP },
  };
...
void BrowserOptionsHandler::RegisterMessages() {
  ...
  web_ui()->RegisterMessageCallback(
   ...
   web_ui()->RegisterMessageCallback(
      "selectCacheLocation",
      base::Bind(&BrowserOptionsHandler::HandleSelectCacheLocation,
                 base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
      "ResetCacheLocation",
      base::Bind(&BrowserOptionsHandler::HandleResetCacheLocation,
                 base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
  ...
  web_ui()->RegisterMessageCallback(
      "selectLanguage",
      base::Bind(&BrowserOptionsHandler::HandleSelectLanguage,
                 base::Unretained(this)));
  web_ui()->RegisterMessageCallback(
  ...
  web_ui()->RegisterMessageCallback("metricsReportingCheckboxChanged",
      base::Bind(&BrowserOptionsHandler::HandleMetricsReportingChange,
                 base::Unretained(this)));
    web_ui()->RegisterMessageCallback("openedAutoClearBrowserData",
      base::Bind(&BrowserOptionsHandler::OnPageOpened,
                 base::Unretained(this)));
    web_ui()->RegisterMessageCallback(
      "loadShortCuts",
      base::Bind(&BrowserOptionsHandler::LoadShortCuts,
                 base::Unretained(this)));
        web_ui()->RegisterMessageCallback(
      "saveShortCuts",
      base::Bind(&BrowserOptionsHandler::SaveShortCuts,
                 base::Unretained(this)));
      web_ui()->RegisterMessageCallback(
      "resetShortCuts",
      base::Bind(&BrowserOptionsHandler::ResetShortCuts,
                 base::Unretained(this)));
      web_ui()->RegisterMessageCallback(
      "defaultCloseTabDirection",
      base::Bind(&BrowserOptionsHandler::HandleDefaultTabDirection,
                 base::Unretained(this)));
       web_ui()->RegisterMessageCallback(
      "defaultOpenTabDirection",
      base::Bind(&BrowserOptionsHandler::HandleDefaultOpenTabDirection,
                 base::Unretained(this)));
}
...
void BrowserOptionsHandler::OnPageOpened(const base::ListValue* value) {
  for (browsing_data::BrowsingDataCounter* counter : counters_) {
    counter->Restart();
  }
}
void BrowserOptionsHandler::ResetShortCuts(const base::ListValue* value) {
   InitShortCuts(true);
    base::StringValue  return_string("wdg");
   web_ui()->CallJavascriptFunctionUnsafe(
    "resetSuccess",
   return_string);
}

void BrowserOptionsHandler::SaveShortCuts(const base::ListValue* value) {

std::string  json_string ;  // = base::UTF16ToUTF8(ExtractStringValue(value));
  //printf("browser_options save shorts %s\n", json_string.c_str());
if (value->GetString(1, &json_string))
{
base::JSONReader  reader;
std::unique_ptr<base::Value> root  = reader.ReadToValue(json_string);
 base::StringValue  short_key_json_1(json_string);
 Profile* profile = Profile::FromWebUI(web_ui());
  PrefService* prefs = profile->GetPrefs();
  prefs->Set(prefs::kShortCutsTable,*root.get());
  web_ui()->CallJavascriptFunctionUnsafe(
    "saveSuccess",
   short_key_json_1);
}
...
void BrowserOptionsHandler::InitShortCuts(bool force){
   Profile* profile = Profile::FromWebUI(web_ui());
   PrefService* prefs = profile->GetPrefs();
  const base::DictionaryValue* mapping  = prefs->GetDictionary(prefs::kShortCutsTable);
  int size  = mapping->size();
  if(mapping&&size!=0&&!force)
    {
      return;
    }
  std::vector<chrome::AcceleratorMapping> accelerators =
      chrome::GetAcceleratorList();
       base::DictionaryValue roots ;
        for (std::map<ui::Accelerator, int>::const_iterator it =
           accelerator_table_.begin(); it != accelerator_table_.end();) {
           it=accelerator_table_.erase(it);
        }
  ...
  for (std::vector<chrome::AcceleratorMapping>::const_iterator it =
       accelerators.begin(); it != accelerators.end(); ++it)
  {
     int count  = GetAcceleratorCount(it->command_id);
    std::unique_ptr<base::ListValue> Key_List(new  base::ListValue());
    for(int  kk = 0;kk<count;kk++)
    {
           ui::Accelerator accelerator;
           GetAccelerator(it->command_id,  kk, &accelerator);
        //  printf(" the  command_id is  %d ,the accelerator keycode  is  %d , the  modifiers is  %d \n", it->command_id,accelerator. key_code(), accelerator.modifiers() );
          base::ListValue* arg_value = new base::ListValue();
           if(accelerator.modifiers() ==2)
            arg_value->AppendString(std::string("Shift"));
          else  if (accelerator.modifiers() ==4)
           arg_value->AppendString(std::string("Ctrl"));
         else  if (accelerator.modifiers() ==8)
           arg_value->AppendString(std::string("Alt"));
         else  if (accelerator.modifiers() ==6)
          {
           arg_value->AppendString(std::string("Shift"));
            arg_value->AppendString(std::string("Ctrl"));
            }
            else if(accelerator.modifiers() ==10)
            {
                arg_value->AppendString(std::string("Shift"));
                arg_value->AppendString(std::string("Alt"));
              }
              arg_value->AppendString(base::IntToString(accelerator. key_code()));
               std::unique_ptr<base::DictionaryValue>details(new base::DictionaryValue());   //3.0
                details->Set("Keys",arg_value);
                Key_List->Append(std::move(details));      //3.0


     }
   roots.Set(base::IntToString(it->command_id), std::move(Key_List));   //wdg
  }
  roots_default = &roots;
  prefs->Set(prefs::kShortCutsTable,roots);
}

void BrowserOptionsHandler::LoadShortCuts(const base::ListValue* value) {
  // printf("BrowserOptionsHandler LoadShortCuts \n");
   Profile* profile = Profile::FromWebUI(web_ui());
  PrefService* prefs = profile->GetPrefs();
  const base::DictionaryValue* mapping  = prefs->GetDictionary(prefs::kShortCutsTable);
   web_ui()->CallJavascriptFunctionUnsafe(
...
bool  BrowserOptionsHandler::GetAccelerator(int cmd_id, int index,
...
int  BrowserOptionsHandler::GetAcceleratorCount(int cmd_id)
{
  int  count = 0;
   for (std::map<ui::Accelerator, int>::const_iterator it =
           accelerator_table_.begin(); it != accelerator_table_.end(); ++it) {
...
void BrowserOptionsHandler::AddCounter(
    std::unique_ptr<browsing_data::BrowsingDataCounter> counter) {
  counter->Init(
   Profile::FromWebUI(web_ui())->GetPrefs(),  //wdg
      base::Bind(&BrowserOptionsHandler::UpdateCounterText,
                 base::Unretained(this)));
  counters_.push_back(std::move(counter));
}

void BrowserOptionsHandler::UpdateCounterText(
    std::unique_ptr<browsing_data::BrowsingDataCounter::Result> result) {
  //printf("ClearBrowserDataHandler UpdateCounterText test_string %ld\n", cache_size_bytes);
  //get the max_mb set in ui setting
 // PrefService* pref_service = Profile::FromWebUI(web_ui())->GetPrefs()
  static const int kBytesInAMegabyte = 1024 * 1024;
   if (result.get()->Finished())
   {
    base::StringValue  cache_string(GetCounterTextFromResult(result.get()));
 // printf("UpdateCounterText the cache_string  is %s\n", cache_string.GetString()->c_str());
    browsing_data::BrowsingDataCounter::ResultInt cache_size_bytes =
       static_cast<const browsing_data::BrowsingDataCounter::FinishedResult*>(
            result.get())->Value();
  PrefService* pref_service = Profile::FromWebUI(web_ui())->GetPrefs();
  int   disk_max_size =  pref_service->GetInteger(prefs::kDiskMaxCacheSize);
  bool  auto_clear_cache =  pref_service->GetBoolean(prefs::kDiskCahceAutoclear);
 //  printf("disk_max_size %d \n", disk_max_size);
  if(auto_clear_cache&&disk_max_size>=100&&cache_size_bytes>kBytesInAMegabyte*100)
  {
//    printf(" the cache need auto clear  \n");
     base::StringValue  cache_string("0");
     Profile* profile = Profile::FromWebUI(web_ui());
    remover_ = BrowsingDataRemoverFactory::GetForBrowserContext(profile);
 // remover_->AddObserver(this);
  int period_selected =4;
  int remove_mask  = 0;
...
void BrowserOptionsHandler::InitializeHandler() {
  ...
  AddCounter(base::WrapUnique(new CacheCounter(profile)));  //add by wdg for cache
  ...
  profile_pref_registrar_.Add(
    ...
    profile_pref_registrar_.Add(
      ...
      base::Bind(&BrowserOptionsHandler::SetupTabPageSettings,
                 base::Unretained(this)));
     profile_pref_registrar_.Add(
      prefs::kOpenDirection,
      base::Bind(&BrowserOptionsHandler::SetupOpenTabPageDirection,
                 base::Unretained(this)));
  profile_pref_registrar_.Add(
  ...
  profile_pref_registrar_.Add(
      ...
      base::Bind(&BrowserOptionsHandler::SetupLanguageSelection,
                 base::Unretained(this)));
...
void BrowserOptionsHandler::InitializePage() {
  ...
  SetupTabPageSettings();//tab direction
  SetupOpenTabPageDirection(); //open tab direction
...
//add  for cache
void BrowserOptionsHandler::HandleSelectCacheLocation(
    const base::ListValue* args) {

  PrefService* pref_service = Profile::FromWebUI(web_ui())->GetPrefs();
  cache_select_folder_dialog_ = ui::SelectFileDialog::Create(
      this, new ChromeSelectFilePolicy(web_ui()->GetWebContents()));
  ui::SelectFileDialog::FileTypeInfo info;
  info.allowed_paths = ui::SelectFileDialog::FileTypeInfo::NATIVE_OR_DRIVE_PATH;
  cache_select_folder_dialog_->SelectFile(
      ui::SelectFileDialog::SELECT_FOLDER,
      l10n_util::GetStringUTF16(IDS_OPTIONS_DOWNLOADLOCATION_BROWSE_TITLE),
      ...
      web_ui()->GetWebContents()->GetTopLevelNativeWindow(),
   (void *) "Cache");
    old_cache_path =  pref_service->GetFilePath(prefs::kDiskCacheDir);
}

void BrowserOptionsHandler::HandleResetCacheLocation(const base::ListValue* args) {
  PrefService* pref_service = Profile::FromWebUI(web_ui())->GetPrefs();
//  printf( "the cache dir is %s\n",pref_service->GetFilePath(prefs::kDiskCacheDir).value().c_str());
  base::FilePath  old_path =  pref_service->GetFilePath(prefs::kDiskCacheDir);
  base::FilePath  default_path = pref_service->GetFilePath(prefs::kDiskDefaultCacheDir);
 ...
 Profile* profile = Profile::FromWebUI(web_ui());
  ...
  remover_->Remove(
      BrowsingDataRemover::Period(
            static_cast<browsing_data::TimePeriod>(period_selected)),
      remove_mask, origin_mask);
  pref_service->SetFilePath(prefs::kDiskCacheDir, pref_service->GetFilePath(prefs::kDiskDefaultCacheDir));
}
}
...
void  BrowserOptionsHandler::FileSelected(const base::FilePath& path, int index,
   ...
   PrefService* pref_service = Profile::FromWebUI(web_ui())->GetPrefs();
  if (select_folder_dialog_.get()&&!strncmp((char *)params, "Download",strlen("Download")))
  {
  //   printf("BrowserOptionsHandler:FileSelected  select_folder_dialog_\n");
    content::RecordAction(UserMetricsAction("Options_SetDownloadDirectory"));
    pref_service->SetFilePath(prefs::kDownloadDefaultDirectory, path);
    pref_service->SetFilePath(prefs::kSaveFileDefaultDirectory, path);
    }
 if( cache_select_folder_dialog_.get()&&!strncmp((char *)params, "Cache",strlen("Cache")))
 {
   ///   printf("BrowserOptionsHandler:FileSelected  cache_select_folder_dialog_ \n");
   content::RecordAction(UserMetricsAction("Options_SetCacheDirectory"));
    if(old_cache_path != path)
    {
    Profile* profile = Profile::FromWebUI(web_ui());
    remover_ = BrowsingDataRemoverFactory::GetForBrowserContext(profile);
    int period_selected =4;
    ...
    remover_->Remove(BrowsingDataRemover::Period(
     ...
     pref_service->SetFilePath(prefs::kDiskCacheDir, path);
  }
...
void BrowserOptionsHandler::HandleDefaultTabDirection(const base::ListValue* args) {
  int tab_direction;
  ExtractIntegerValue(args, &tab_direction);
   {
    // printf("HandleDefaultTabDirection  the tab_direction %d\n", tab_direction);
      PrefService* pref_service = Profile::FromWebUI(web_ui())->GetPrefs();
      pref_service->SetInteger(prefs::kCloseTabSwitch, tab_direction);
      SetupTabPageSettings();
  }
}
void BrowserOptionsHandler::HandleDefaultOpenTabDirection(const base::ListValue* args) {
  int tab_direction;
  ExtractIntegerValue(args, &tab_direction);
  {
  //  printf("HandleDefaultOpenTabDirection  the tab_direction %d\n", tab_direction);
      PrefService* pref_service = Profile::FromWebUI(web_ui())->GetPrefs();
      pref_service->SetInteger(prefs::kOpenDirection, tab_direction);
      SetupOpenTabPageDirection();
  }
}
...
static void ReloadLocaleResourcesOnFileThread(std::string locale) {
  ...
  if (loaded_locale != locale) {
   ...
   content::BrowserThread::PostTask(
      ...
      base::Bind(&SetLocale, locale));
}

void BrowserOptionsHandler::HandleSelectLanguage(const base::ListValue* args) {
  std::string locale;
  if (args->GetString(0, &locale)) {
    content::BrowserThread::PostTask(
      content::BrowserThread::FILE, FROM_HERE,
      base::Bind(&ReloadLocaleResourcesOnFileThread, locale));
  }
}
...
void BrowserOptionsHandler::SetupTabPageSettings() {

  PrefService* pref_service = Profile::FromWebUI(web_ui())->GetPrefs();
  const PrefService::Preference* default_font_size =
      pref_service->FindPreference(prefs::kCloseTabSwitch);
  base::DictionaryValue dict;
  dict.SetInteger("value",
                  pref_service->GetInteger(prefs::kCloseTabSwitch));
  // printf("SetupTabPageSettings the value is %d \n", pref_service->GetInteger(prefs::kCloseTabSwitch));
  ...
  // adapted to consider two prefs. It may be better to refactor
  // CreateValueForPref so it can be called from here.
  if (default_font_size->IsManaged()) {
      dict.SetString("controlledBy", "policy");
  } else if (default_font_size->IsExtensionControlled() ) {
      dict.SetString("controlledBy", "extension");
  }

  web_ui()->CallJavascriptFunctionUnsafe("BrowserOptions.setCloseTabDiection", dict);
}

void BrowserOptionsHandler::SetupOpenTabPageDirection() {

  PrefService* pref_service = Profile::FromWebUI(web_ui())->GetPrefs();
  const PrefService::Preference* default_font_size =
      pref_service->FindPreference(prefs::kOpenDirection);
  base::DictionaryValue dict;
  dict.SetInteger("value",
                  pref_service->GetInteger(prefs::kOpenDirection));
  //printf("SetupOpenTabPageDirection the value is %d \n", pref_service->GetInteger(prefs::kOpenDirection));
  ...
  web_ui()->CallJavascriptFunctionUnsafe("BrowserOptions.setOpenTabDiection", dict);
}

void BrowserOptionsHandler::SetupLanguageSelection() {
  PrefService* prefs = g_browser_process->local_state();
  std::string locale = prefs->GetString(prefs::kApplicationLocale);
  if (locale.empty()) {
    locale = l10n_util::GetApplicationLocale(locale);
  }

  web_ui()->CallJavascriptFunctionUnsafe(
    "BrowserOptions.setSelectedLanguage", base::StringValue(locale));
}
