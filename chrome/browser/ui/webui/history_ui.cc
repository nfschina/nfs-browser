...
content::WebUIDataSource* CreateHistoryUIHTMLSource(Profile* profile) {
  ...
  source->AddLocalizedString("searchPlaceholder",
                             IDS_HISTORY_SEARCH_PLACEHOLDER);//yana add 161013
  ...
  source->AddLocalizedString("addBookmark", IDS_HISTORY_ADD_BOOKMARK);//yana add 161013
  source->AddLocalizedString("removeFromVisit", IDS_REMOVE_FROM_VISIT);
  source->AddLocalizedString("searchMoreAboutThisSite", IDS_SEARCH_MORE_ABOUT_THIS_SITE);//yana add 161013
...
base::RefCountedMemory* HistoryUI::GetFaviconResourceBytes(
  ...
  return ResourceBundle::GetSharedInstance().
      LoadDataResourceBytesForScale(IDD_SHOW_HISTORY, scale_factor);  //IDR_HISTORY_FAVICON yana 161123
}
