...
void NTPResourceCache::CreateNewTabIncognitoHTML() {
  ...
  if (profile_->IsGuestSession()) {
    localized_strings.SetString("guestTabDescription",
        l10n_util::GetStringUTF16(IDS_NEW_TAB_OTR_DESCRIPTION));
    localized_strings.SetString("guestTabHeading",
        l10n_util::GetStringUTF16(IDS_NEW_TAB_OTR_HEADING));
  } else {
    localized_strings.SetString("incognitoTabDescription",
        l10n_util::GetStringUTF16(IDS_NEW_TAB_OTR_DESCRIPTION_CDOS));
    localized_strings.SetString("incognitoTabHeading",
        l10n_util::GetStringUTF16(IDS_NEW_TAB_OTR_HEADING_CDOS));
    localized_strings.SetString("incognitoWelcome",
        l10n_util::GetStringUTF16(IDS_NEW_TAB_INCOGNITO_WELCOME));
    localized_strings.SetString("incognito",
        l10n_util::GetStringUTF16(IDS_NEW_TAB_INCOGNITO_TEXT));
    localized_strings.SetString("incognitoMode",
        l10n_util::GetStringUTF16(IDS_NEW_TAB_INCOGNITO_MODE));
  }
  ...
  const ui::ThemeProvider& tp =
      ThemeService::GetThemeProviderForProfile(profile_);
  int dark = tp.GetDisplayProperty(ThemeProperties::THEME_ICONS_DARK);
  localized_strings.SetString("is_icons_dark", dark ? "true" : "false");
...
void NTPResourceCache::CreateNewTabHTML() {
  ...
  load_time_data.SetString("title",
      l10n_util::GetStringUTF16(IDS_NEW_TAB_TITLE));
  load_time_data.SetString("add",
      l10n_util::GetStringUTF16(IDS_ADD));
  load_time_data.SetString("newtab_enter_name",
      l10n_util::GetStringUTF16(IDS_NEWTAB_ENTER_NAME));
  load_time_data.SetString("newtab_type_url",
      l10n_util::GetStringUTF16(IDS_NEWTAB_TYPE_URL));
  load_time_data.SetString("popular_websites",
      l10n_util::GetStringUTF16(IDS_NEWTAB_POPULAR_WEBSITES));
  load_time_data.SetString("bookmarks",
      l10n_util::GetStringUTF16(IDS_NEWTAB_BOOKMARKS));
  load_time_data.SetString("recently_used",
      l10n_util::GetStringUTF16(IDS_NEWTAB_RECENTLY_USED));
  load_time_data.SetString("open_in_new_tab",
      l10n_util::GetStringUTF16(IDS_NEWTAB_CONTEXTMENU_OPEN_IN_NEW_TAB));
  load_time_data.SetString("open_in_new_window",
      l10n_util::GetStringUTF16(IDS_NEWTAB_CONTEXTMENU_OPEN_IN_NEW_WINDOW));
  load_time_data.SetString("open_incognito_window",
      l10n_util::GetStringUTF16(IDS_NEWTAB_CONTEXTMENU_OPEN_IN_INCOGNITO_WINDOW));
  load_time_data.SetString("edit",
      l10n_util::GetStringUTF16(IDS_EDIT2));
  load_time_data.SetString("delete",
      l10n_util::GetStringUTF16(IDS_MD_HISTORY_DELETE));
  load_time_data.SetString("url_invalid",
      l10n_util::GetStringUTF16(IDS_NEWTAB_URL_IS_INVALID));
  load_time_data.SetString("url_is_empty",
      l10n_util::GetStringUTF16(IDS_NEWTAB_URL_OR_NAME_EMPTY));
  load_time_data.SetString("unknown_error",
      l10n_util::GetStringUTF16(IDS_NEWTAB_UNKNOWN_ERROR));

   const ui::ThemeProvider& tp =
      ThemeService::GetThemeProviderForProfile(profile_);
    load_time_data.SetBoolean("hasCustomBackground",
                               tp.HasCustomImage(IDR_THEME_NTP_BACKGROUND));
...
void NTPResourceCache::CreateNewTabCSS() {
  ...
  substitutions["themeId"] =
      profile_->GetPrefs()->GetString(prefs::kCurrentThemeID);
      std::string thm = profile_->GetPrefs()->GetString(prefs::kCurrentThemeID);
  ...
  substitutions["ntpBackgroundOffset"] = GetNewTabBackgroundOffset();
...
std::string NTPResourceCache::GetNewTabBackgroundOffset() const{
  int offset_y = 0;
  Browser* browser = chrome::FindBrowserWithProfile(profile_);
  if (browser) {
    gfx::Point offsetPoint = BrowserView::GetBrowserViewForBrowser(
            browser)->OffsetPointForNTPBackgroundImage();
    offset_y = offsetPoint.y();
  }
  return ThemeProperties::OffsetToString(0, -offset_y);
}
