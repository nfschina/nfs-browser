...
class OpaqueBrowserFrameViewLayoutDelegate {
 public:
  ...
  virtual bool ShouldShowTabStripTnsertsTop() const = 0;
  ...
  //[zhangyq] add for simple web vedio window.
  virtual bool IsSimpleWebVedio() const = 0;
  virtual bool hasCustomImage() const = 0;
