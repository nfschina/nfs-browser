...
void SystemMenuModelBuilder::BuildMenu(ui::SimpleMenuModel* model) {
  ...
  if (browser()->is_type_tabbed())
    BuildSystemMenuForBrowserWindowNfs(model);
  else
...
void SystemMenuModelBuilder::BuildSystemMenuForBrowserWindowNfs(
    ui::SimpleMenuModel* model) {
  model->AddCheckItemWithStringId(IDC_SHOW_SEARCHBAR, IDS_SHOW_SEARCHBAR);
  model->AddCheckItemWithStringId(IDC_SHOW_BOOKMARKBAR, IDS_SHOW_BOOKMARKBAR);  
  model->AddCheckItemWithStringId(IDC_SHOW_TOOLBAR, IDS_SHOW_TOOLBAR);
}
