...
class OpaqueBrowserFrameView : public BrowserNonClientFrameView,
                               ...
                               public nfs_sync::NfsSyncObserver {
 public:
  ...
  // bool IsDownloadManager() const override;
  bool IsSimpleWebVedio() const override;
  bool hasCustomImage() const override;
  void OnLoginSuccess(const std::string& name,
 ...
 private:
  ...
  views::ImageButton* pin_button_;
  views::ImageButton* unpin_button_;
  views::ImageButton* return_button_;
  views::ImageButton* theme_button_;
  views::ImageButton* account_button_;
  ...
  bool is_from_simple_web_;

  bool is_simple_web_vedio_;
