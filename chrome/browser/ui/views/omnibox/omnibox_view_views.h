...
class OmniboxViewViews
 ...
 public:
  ...
  void CloseUrlFloatingView() override;
  ...
  void OnUrlFloatingViewClosed(int result);
 ...
 private:
  ...
  void CheckAndShowFloatLayer(const gfx::Point& location);

  bool IsInputTextURL(base::string16 text) const;
  ...
  std::unique_ptr<OmniboxPopupView> dropdown_view_;

  std::unique_ptr<OmniboxUrlFloatingView> url_floating_view_;
