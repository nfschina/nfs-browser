...
class BookmarkMenuDelegate : public bookmarks::BaseBookmarkModelObserver,
 ...
 private:
  ...
  typedef std::map<const bookmarks::BookmarkNode*, views::MenuItemView*>
      NodeToMenuMap;
  typedef std::map<int, const bookmarks::BookmarkNode*> NonBookmarkNodeMap;
  ...
  void AddMenuToNonBookmarkNodeMap(int id, const bookmarks::BookmarkNode* parent);
  ...
  NonBookmarkNodeMap none_bookmark_node_map_;
