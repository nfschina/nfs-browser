...
#ifndef CHROME_BROWSER_UI_VIEWS_BOOKMARKS_NFSBROWSER_BOOKMARK_EDITOR_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_BOOKMARKS_NFSBROWSER_BOOKMARK_EDITOR_VIEW_H_
...
//
// To use BookmarkBubbleView invoke the static show method.

class BookmarkBubbleView : public BookmarkEditor,
 ...
 public:
  ...
  static BubbleDelegateView* bookmark_bubble() { return bookmark_bubble_; }
  ...
  // Creates a Window and adds the BookmarkBubbleView to it. When the window is
  // closed the BookmarkBubbleView is deleted.
 ...
 private:
  ...
  EditorNode* FindNodeWithID(BookmarkBubbleView::EditorNode* node, int64_t id);
  ...
  base::string16 GetBookmarkedLocation(GURL url);

  void TraverseNode(base::string16& location, const bookmarks::BookmarkNode* node);
  ...
  views::LabelButton* new_folder_button_;
...
#endif  // CHROME_BROWSER_UI_VIEWS_BOOKMARKS_NFSBROWSER_BOOKMARK_EDITOR_VIEW_H_
