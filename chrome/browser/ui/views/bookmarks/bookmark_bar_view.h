...
class BookmarkBarView : public views::AccessiblePaneView,
 ...
 private:
  ...
  // Creates the button for rendering the bookmark manager page shortcut.
  views::LabelButton* CreateBookmarkManagerPageShortcutButton();
  ...
  // Shows the Bookmark manager page shortcut.
  views::LabelButton* bookmark_manager_page_shortcut_;
