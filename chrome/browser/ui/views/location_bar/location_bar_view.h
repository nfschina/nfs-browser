...
class LocationBarView : public LocationBar,
 ...
 public:
  ...
  QrButton* qr_button() { return qr_; }

  CompatibleModeButton* compatibleMode_button() { return compatible_mode_button_; }
  ...
  void ShowOmniboxDropdownView();
  void CloseOmniboxDropdownView();
  bool IsOmniboxDropdownViewOpen();
 ...
 private:
  ...
  DropDownView* dropdown_view_;

  CompatibleModeButton* compatible_mode_button_;
