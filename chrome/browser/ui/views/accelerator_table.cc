...
// #endif  // ENABLE_BASIC_PRINTING
 ...
 // { ui::VKEY_R, ui::EF_ALT_DOWN | ui::EF_CONTROL_DOWN, IDC_RELOAD_ALL },
  { ui::VKEY_R, ui::EF_ALT_DOWN, IDC_RELOAD_ALL },
...
// #endif
    ...
    // IDC_TOGGLE_FULLSCREEN_TOOLBAR },  //wdg add  浏览器放大镜
  ...
  { ui::VKEY_F4, ui::EF_NONE, IDC_ADDRESSBAR_LIST }, //wdg add  for 弹出地址栏下拉列表
  ...
  { ui::VKEY_F7, ui::EF_NONE, IDC_RELOAD_ALL },
...
// #endif
  ...
  { ui::VKEY_N, ui::EF_SHIFT_DOWN | ui::EF_CONTROL_DOWN,
   ...
   // { ui::VKEY_S, ui::EF_SHIFT_DOWN | ui::EF_CONTROL_DOWN,
    // IDC_BROWSER_SHOW_SRCOLLBAR }, //浏览器显示或者隐藏侧边栏
  { ui::VKEY_B, ui::EF_SHIFT_DOWN | ui::EF_CONTROL_DOWN,
    IDC_SHOW_BOOKMARK_BAR },  //显示隐藏书签栏
