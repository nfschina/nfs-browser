...
#ifndef CHROME_BROWSER_UI_VIEWS_SEARCHBAR_SEARCHBOX_RESULT_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_SEARCHBAR_SEARCHBOX_RESULT_VIEW_H_
...
class SearchBarView;
class SearchboxPopupContentsView;
...
class SearchboxResultView : public views::View,
 ...
 public:
  ...
  SearchboxResultView(SearchboxPopupContentsView* model,
                    int model_index,
                    SearchBarView* search_bar_view,
                    const gfx::FontList& font_list);
  ~SearchboxResultView() override;
 ...
 private:
  ...
  SearchboxPopupContentsView* model_;
  size_t model_index_;
  ...
  DISALLOW_COPY_AND_ASSIGN(SearchboxResultView);
};

#endif  // CHROME_BROWSER_UI_VIEWS_SEARCHBAR_SEARCHBOX_RESULT_VIEW_H_
