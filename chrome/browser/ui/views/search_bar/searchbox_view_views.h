...
#ifndef CHROME_BROWSER_UI_VIEWS_SEARCHBAR_SEARCHBOX_VIEW_VIEWS_H_
#define CHROME_BROWSER_UI_VIEWS_SEARCHBAR_SEARCHBOX_VIEW_VIEWS_H_
...
#include "chrome/browser/ui/search_bar/searchbox_view.h"
...
class SearchboxViewViews
 ...
 public:
  ...
  SearchboxViewViews(SearchboxEditController* controller,
                   Profile* profile,
                   CommandUpdater* command_updater,
                   bool popup_window_mode,
                   SearchBarView* search_bar,
                   const gfx::FontList& font_list);
  ~SearchboxViewViews() override;
 ...
 private:
  ...
  int GetSearchboxTextLength() const override;
  ...
  std::unique_ptr<SearchboxPopupView> popup_view_;
  ...
  base::WeakPtrFactory<SearchboxViewViews> weak_ptr_factory_;

  DISALLOW_COPY_AND_ASSIGN(SearchboxViewViews);
};

#endif  // CHROME_BROWSER_UI_VIEWS_SEARCHBAR_SEARCHBOX_VIEW_VIEWS_H_
