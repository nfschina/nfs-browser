...
int GetLayoutConstant(LayoutConstant constant) {
  ...
  const int kTabHeight[] = {30, 30, 30};
  const int kTabPinnedContentWidth[] = {20, 20, 20};
#if defined(OS_MACOSX)
  const int kTabstripNewTabButtonOverlap[] = {1, 1, 1};
  const int kTabstripTabOverlap[] = {1, 1, 1};
#else
  const int kTabstripNewTabButtonOverlap[] = {1, 1, 1};
  const int kTabstripTabOverlap[] = {1, 1, 1};
#endif
...
gfx::Insets GetLayoutInsets(LayoutInset inset) {
  ...
  const int kTabBottomPadding[] = {7, 7, 7};
  const int kTabLeftPadding[] = {12, 12, 12};
  const int kTabRightPadding[] = {8, 8, 8};
  const int kTabTopPadding[] = {7, 7, 7};
  const int kToolbarBottomPadding[] = {7, 7, 7};
...
gfx::Size GetLayoutSize(LayoutSize size) {
  const int kNewTabButtonWidth[] = {40, 40, 40};
  const int kNewTabButtonHeight[] = {30, 30, 30};
