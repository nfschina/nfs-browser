...
bool BrowserTabStripModelDelegate::CanBookmarkCurrentPage() const {
  return chrome::CanBookmarkCurrentPage(browser_);
}
...
void BrowserTabStripModelDelegate::BookmarkCurrentPage() {
  chrome::BookmarkCurrentPage(browser_);
}
...
void BrowserTabStripModelDelegate::SuspendOtherTabs() {
  browser_->PurgeMemoryAndDiscardTab();
}
