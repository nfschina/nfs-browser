...
class FeedbackMenuModel : public ui::SimpleMenuModel {
 public:
  FeedbackMenuModel(ui::SimpleMenuModel::Delegate* delegate, Browser* browser);
  ~FeedbackMenuModel() override;

 private:
  void Build(Browser* browser);

  DISALLOW_COPY_AND_ASSIGN(FeedbackMenuModel);
};
...
class AppMenuModel : public ui::SimpleMenuModel,
 ...
 private:
  ...
  //Feedback menu
  std::unique_ptr<FeedbackMenuModel> feedback_menu_model_;
