...
class BrowserWindow : public ui::BaseWindow {
 public:
  ...
  virtual SearchBarView* GetSearchBar() const = 0;
  ...
  virtual void ShowBookmarkBubble(const GURL& url,
      const base::string16 title, bool already_bookmarked) = 0;

  virtual void ShowQrBubble(GURL& url) = 0;
  ...
  virtual bool DownloadManagerIsExist() = 0;
  virtual bool DownloadManagerIsActive() = 0;
  virtual bool DownloadNewTaskIsExist() = 0;
