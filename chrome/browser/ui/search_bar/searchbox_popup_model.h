...
#ifndef CHROME_BROWSER_UI_SEARCHBAR_SEARCHBOX_POPUP_MODEL_H_
#define CHROME_BROWSER_UI_SEARCHBAR_SEARCHBOX_POPUP_MODEL_H_
...
class SearchboxPopupModel {
 public:
  ...
  SearchboxPopupModel(SearchboxPopupView* popup_view, SearchboxEditModel* edit_model);
  ~SearchboxPopupModel();
  ...
  SearchboxPopupView* view() const { return view_; }
 ...
 private:
  ...
  SearchboxPopupView* view_;

  SearchboxEditModel* edit_model_;
  ...
  DISALLOW_COPY_AND_ASSIGN(SearchboxPopupModel);
};

#endif  // CHROME_BROWSER_UI_SEARCHBAR_SEARCHBOX_POPUP_MODEL_H_
