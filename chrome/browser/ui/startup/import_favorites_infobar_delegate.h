...
#ifndef CHROME_BROWSER_UI_STARTUP_IMPORT_FAVORITES_INFOBAR_DELEGATE_H_
#define CHROME_BROWSER_UI_STARTUP_IMPORT_FAVORITES_INFOBAR_DELEGATE_H_
...
class ImportFavoritesInfoBarDelegate : public ConfirmInfoBarDelegate {
 public:
 ...
 protected:
  explicit ImportFavoritesInfoBarDelegate(Profile* profile);
  ~ImportFavoritesInfoBarDelegate() override;
 ...
 private:
  ...
  base::WeakPtrFactory<ImportFavoritesInfoBarDelegate> weak_factory_;

  DISALLOW_COPY_AND_ASSIGN(ImportFavoritesInfoBarDelegate);
};

}  // namespace chrome

#endif  // CHROME_BROWSER_UI_STARTUP_IMPORT_FAVORITES_INFOBAR_DELEGATE_H_