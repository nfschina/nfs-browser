...
enum ViewID {
  ...
  VIEW_ID_SCREENSHOT_BUTTON,
  VIEW_ID_DOWNLOAD_BUTTON,
  VIEW_ID_APP_MANAGER_BUTTON,
  VIEW_ID_WECHAT_BUTTON,
  VIEW_ID_SEARCHBAR,
  VIEW_ID_SEARCH_BUTTON,
  VIEW_ID_DROPDOWN_BUTTON,
  VIEW_ID_QR_BUTTON,
  VIEW_ID_COMPATIBLE_MODE_BUTTON,
