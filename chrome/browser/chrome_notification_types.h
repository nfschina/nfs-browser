...
enum NotificationType {
  ...
  // mouse pressed on the browser view(client view)
  NOTIFICATION_MOUSE_PRESSED,

  // show or close the tab preview
  NOTIFICATION_SHOW_TAB_SCREEN_SHOT,

  NOTIFICATION_UNSHOW_TAB_SCREEN_SHOT,

  NOTIFICATION_DOWNLOAD_FEEDBACK,

  NOTIFICATION_DOWNLOAD_PROGRESS,

  NOTIFICATION_NTP_BACKGROUND_OFFSET,

  NOTIFICATION_THEME_GALLERY_CHANGE,
  NOTIFICATION_THEME_PACK_READY,

  NOTIFICATION_BROWSER_WINDOW_SHOWN,
