...
const char kWebKitClickPrerenderEnabled[] = "webkit.webprefs.click_prerender_enabled";
const char kWebKitMouseOverPrerenderEnabled[] = "webkit.webprefs.mouse_over_prerender_enabled";
...
//yana add 20160818
const char kLockKeyword[] = "browser.lock";
...
// String which specifies where to download files to by selected.
const char kDownloadDirectorySelected[] = "download.directory_selected";

const  char kOriginalDownloadDirectoty[] = "download.original_path";  //wdg
...
const char kDiskDefaultCacheDir[] = "browser.disk_default_cache_dir"; //wdg
const char kDiskMaxCacheSize[] = "browser.max_disk_cache_size"; //wdg
const char kDiskCahceAutoclear[] = "browser.disk_cache_auto_clear";  // add wdg for auto clear cache config
...
//add by wdg  for the new pref
const char kShowMarkedBar[] = "browser.show_markedbar";
const char kShowSearchBar[]= "browser.show_searchbar";
const char kShowToolbar[]= "browser.show_toolbar";

//  the browsing mode , it is a interger value
const char kBrowseringMode[]= "browser.browsing_mode";
 // the address bar func show
const char kAddressAutofill[] = "browser.address_autofill";
const char kAddressHistory[] = "browser.address_history";
const char kAddressSaved[] = "browser.address_saved";
const char kAddressClip[] = "browser.address_copy";
const char kAddressCompatibleMode[] = "browser.compatible_mode";

  /////////////////////
  //add  for the tag page setting
const char kNewTabPage[]= "tabs.newtabpageishomepage";
const char kCloseMultiTabs[] = "browser.closemultitabs";
const char kCloseAutoClearBrowserData[] = "close.clearbrowserdata";
const char kDoubleClickToClose[] = "browser.closetabmode";
const char kClickToCloseNotice[] = "browser.closereopenlasttabs";

const char kCloseTabSwitch[] = "browser.close.swichpagemode";
const char kOpenNewTabPage[] = "browser.opentabs.newtabpage";
const char kBoldInBackground[] = "browser.opentabs.background";
const char kPomptInNewWindow[] = "browser.opentabs.promtwindow";
const char kOpenDirection[]= "browser.opentabs.direction";
  //end  for  the tab pages

//add  the download  options
const char kDownloadMaxSpeed[] = "download.maxspeed";
const char kDownloadNeedLimitSpeed[]= "download.isLimitSpeed";
const char kNoteDownloadQuit[]= "download.quitnotice";
const char kPromptDownload[] = "download.finishnotice";
//const char kVoiceNoteDownload[] = "download.Innotice";
const char kContinueLastDownload[] = "download.lastsession";
const char kDefaultBrowserCheck[] = "browser.check_defalutbrowser";
const char kMurlUpdate[] = "browser.check_murlupdate";

const char kEnableTabPreview[] = "browser.enable_tab_preview";
const char kTabMaxIndex[] = "tab.maxindex";

const char kEnableClickPrerender[] = "browser.enable_click_prerender";
const char kEnableMouseOverPrerender[] = "browser.enable_mouse_over_prerender";

const char kEnableShortCuts[] = "browser.enable_short_cuts";
const char kShortCutsTable[] = "browser.shortcut_table"; //快捷键设置表

// const char kUserID[] = "unique_id";
const char kShouldShowImportDialog[] = "should_show_import_dialog";

const char kBrowserLastUpdateVersion[] = "1.1.1.1";

const char kBrowserShouldShowWelcome[] = "should_show_welcome";
...
const char kEnablePrivacyProtocal[] = "enable_privacy_protocal";

const char kEnableSyncBookmark[] = "enable_sync_bookmark";

const char kEnableSyncSkin[] = "enable_sync_skin";

const char kAutoUpdateToLatest[] = "browser.auto_update_to_latest";

const char kEnableSyncPassword[] = "enable_sync_password";

const char kShowVideoToolbar[] = "browser.videoToolbar";

const char kShowCopySearchToolbar[] = "browser.copySearch";

const char kFirstSyncPassword[] = "first_sync_password";
