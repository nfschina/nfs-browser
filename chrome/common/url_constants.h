...
extern const char kChromeUICaptureURL[];
...
extern const char kChromeUIDownloadsNewURL[];
...
extern const char kChromeUILastTabsListURL[];//yana add 170410
...
extern const char kChromeUIDownloadSettingsURL[];
...
extern const char kChromeUICaptureHost[];
...
extern const char kChromeUIDownloadsNewHost[];
...
extern const char kChromeUILastTabsListHost[];//yana add 170410
...
extern const char kChromeUIAccountLoginURL[];
extern const char kChromeUIAccountLoginHost[];
...
extern const char kAboutNfsURL[];

extern const char kFeedbackNfsURL[];
extern const char kFeedbackNfsURLEN[];

extern const char kOfficialForumURL[];

extern const char kUpdateNfsURL[];

extern const char kAboutNfsHost[];

extern const char kFeedbackNfsHost[];

extern const char kUpdateNfsHost[];

extern const char kThemeGalleryURL[];

extern const char kThemeGalleryHost[];

extern const char kAppManagerURL[];

extern const char kAppManagerHost[];

extern const char kWebStoreURL[];
extern const char kWebStoreURLOrigin[];

extern const char kNfsSchemes[];

extern const char kChromiumURL[];
extern const char kSourceURL[];
