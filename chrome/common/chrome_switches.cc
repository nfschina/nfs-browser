...
const char kRegisterBrowser[]            = "register-browser";
...
extern const char kDisableExtensionLazyLoad[] = "no-extension-lazyload"; //huk

extern const char kDisableCrashedInfoBar[] = "no-crash-infobar"; //wdq
...
const char kEnableSafeBrowsermode[] = "safe_mode";

const char kIntervalTime[] = "interval-time";
const char kUpdateURL[] = "updateurl";

const char kEnableBT[] = "enable_bt";

const char kDisallowPrivacyProtocal[] = "disallow_privacy_protocal";
