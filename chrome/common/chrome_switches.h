...
extern const char kRegisterBrowser[];
...
extern const char kEnableSafeBrowsermode[];
extern const char kDisableExtensionLazyLoad[]; //huk
extern const char kDisableCrashedInfoBar[]; //wdq

extern const char kIntervalTime[];  // wangpp
extern const char kUpdateURL[];  // wangpp

extern const char kEnableBT[];

extern const char kDisallowPrivacyProtocal[];
