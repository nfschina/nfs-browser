...
void MimeUtil::AddSupportedMediaFormats() {
  ...
  //add by luyue
  //support .mov
  CodecSet mov_audio_codecs;
  mov_audio_codecs.insert(OPUS);
  mov_audio_codecs.insert(VORBIS);
  CodecSet mov_video_codecs;
  mov_video_codecs.insert(VP8);
  mov_video_codecs.insert(VP9);
  CodecSet mov_codecs(mov_audio_codecs);
  mov_codecs.insert(mov_video_codecs.begin(), mov_video_codecs.end());

  //support .rm .rmvb
  //浏览器目前不支持播放rm
  CodecSet rm_audio_codecs;
  rm_audio_codecs.insert(OPUS);
  rm_audio_codecs.insert(VORBIS);
  CodecSet rm_video_codecs;
  rm_video_codecs.insert(VP8);
  rm_video_codecs.insert(VP9);
  CodecSet rm_codecs(rm_audio_codecs);
  rm_codecs.insert(rm_video_codecs.begin(), rm_video_codecs.end());

  //support .avi
  CodecSet avi_audio_codecs;
  avi_audio_codecs.insert(OPUS);
  avi_audio_codecs.insert(VORBIS);
  CodecSet avi_video_codecs;
  avi_video_codecs.insert(VP8);
  avi_video_codecs.insert(VP9);
  CodecSet avi_codecs(avi_audio_codecs);
  avi_codecs.insert(avi_video_codecs.begin(), avi_video_codecs.end());

  //support .flv
  CodecSet flv_audio_codecs;
  flv_audio_codecs.insert(OPUS);
  flv_audio_codecs.insert(VORBIS);
  CodecSet flv_video_codecs;
  flv_video_codecs.insert(VP8);
  flv_video_codecs.insert(VP9);
  CodecSet flv_codecs(flv_audio_codecs);
  flv_codecs.insert(flv_video_codecs.begin(), flv_video_codecs.end());

  //support .mkv
  CodecSet mkv_audio_codecs;
  mkv_audio_codecs.insert(OPUS);
  mkv_audio_codecs.insert(VORBIS);
  CodecSet mkv_video_codecs;
  mkv_video_codecs.insert(VP8);
  mkv_video_codecs.insert(VP9);
  ...
  //add by luyue
  AddContainerWithCodecs("audio/quicktime", mov_audio_codecs, false);  
  DCHECK(!mov_video_codecs.empty());
  AddContainerWithCodecs("video/quicktime", mov_codecs, false); 
  AddContainerWithCodecs("audio/vnd.rn-realmedia", rm_audio_codecs, false);  
  DCHECK(!rm_video_codecs.empty());
  AddContainerWithCodecs("video/vnd.rn-realmedia", rm_codecs, false);
  AddContainerWithCodecs("application/vnd.rn-realmedia", rm_codecs, false);
  AddContainerWithCodecs("audio/x-msvideo", avi_audio_codecs, false);
  DCHECK(!avi_video_codecs.empty());
  AddContainerWithCodecs("video/x-msvideo", avi_codecs, false);
  AddContainerWithCodecs("audio/x-flv", flv_audio_codecs, false);
  DCHECK(!flv_video_codecs.empty());
  AddContainerWithCodecs("video/x-flv", flv_codecs, false);
  AddContainerWithCodecs("audio/x-matroska", mkv_audio_codecs, false);
  DCHECK(!mkv_video_codecs.empty());
  AddContainerWithCodecs("video/x-matroska", mkv_codecs, false);
  //add end
